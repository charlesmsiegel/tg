...
class TestConditionalFieldsMixin(TestCase):
    ...
    def test_basic_form_with_rules(self):
        ...
        self.assertEqual(rules["detail"]["visible_when"]["category"]["value_is"], "a")
...
class TestConditionalFieldsWithChainedSelect(TestCase):
    ...
    def test_combined_mixins(self):
        ...
        self.assertEqual(
            rules["pooled"]["visible_when"]["example"]["metadata_is"], {"poolable": "true"}
        )
...
class TestConditionalFieldsRuleTypes(TestCase):
    ...
    def test_value_in_rule(self):
        ...
        self.assertEqual(rules["detail"]["hidden_when"]["category"]["value_in"], ["a", "b"])
    ...
    def test_value_not_in_rule(self):
        ...
        self.assertEqual(rules["detail"]["visible_when"]["category"]["value_not_in"], ["a"])
    ...
    def test_metadata_truthy_rule(self):
        ...
        self.assertEqual(rules["pooled"]["visible_when"]["example"]["metadata_truthy"], "poolable")
