...
from widgets.templatetags.widget_media import page_media
...
class TestFormsetManagerScript(TestCase):
    ...
    def test_render_formset_manager_script(self):
        ...
        self.assertIn("widgets/formset_manager.js", html)

    def test_render_formset_manager_script_is_independent(self):
        """Test repeated rendering returns the same external script."""
        html1 = render_formset_manager_script()
        html2 = render_formset_manager_script()

        self.assertIn("widgets/formset_manager.js", html1)
        self.assertEqual(html2, html1)

    def test_repeated_script_render(self):
        """Test repeated rendering needs no global flag."""
        render_formset_manager_script()
        html = render_formset_manager_script()
        self.assertIn("widgets/formset_manager.js", html)
    ...
    def test_js_contains_formset_manager_class(self):
        ...
        self.assertIn(
            ...
            Path(finders.find("widgets/formset_manager.js")).read_text(encoding="utf-8"),
        )

    def test_js_contains_init_method(self):
        """Test JavaScript contains init method."""
        self.assertIn(
            "init()", Path(finders.find("widgets/formset_manager.js")).read_text(encoding="utf-8")
        )
...
class TestFormsetTemplateTags(TestCase):
    ...
    def test_formset_script_tag(self):
        ...
        context = Context({})
        formset_script(context)
        result = str(page_media(context))
        self.assertIn("widgets/formset_manager.js", result)
...
class TestFormsetBlockTag(TestCase):
    ...
    def test_formset_block_tag_renders_js_once(self):
        ...
        count = result.count("widgets/formset_manager.js")
