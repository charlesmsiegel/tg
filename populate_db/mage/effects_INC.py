...
effect.description = "The mage is able to communicate directly with the target, mind-to-mind."
effect.save()
...
effect_channel_quintessence, _ = Effect.objects.get_or_create(name="Channel Quintessence", prime=3)
...
effect, _ = Effect.objects.get_or_create(name="Luck's Blessing/Curse", spirit=3, entropy=2)
...
effect, _ = Effect.objects.get_or_create(name="Bum a Dollar From the Universe", matter=2, entropy=2)
...
effect, _ = Effect.objects.get_or_create(name="Caesar's Due", correspondence=3, entropy=2, prime=2)
...
effect.add_source("Mage: The Ascension (Second Edition)", 194)
effect.add_source("Mage: The Ascension (Revised)", 163)
effect, _ = Effect.objects.get_or_create(name="Luck Be a Lady Tonight", spirit=2, entropy=1)
...
effect, _ = Effect.objects.get_or_create(name="Nobody Dies in Vegas", correspondence=4, entropy=4)
...
effect, _ = Effect.objects.get_or_create(name="Rival's Curse", correspondence=2, entropy=4)
...
effect, _ = Effect.objects.get_or_create(name="Sha'ir's Sentence", life=2, entropy=3, mind=2)
...
effect.save()
effect.add_source("Digital Web", 98)
effect, _ = Effect.objects.get_or_create(name="Encode", correspondence=2, life=2, prime=2)
effect.description = (
...
effect, _ = Effect.objects.get_or_create(name="FIRP", life=3, forces=3, entropy=4, mind=5, prime=2)
...
effect, _ = Effect.objects.get_or_create(name="Fractal Encryption", forces=2, entropy=3, prime=2)
...
effect.save()
effect.add_source("Digital Web", 98)
effect, _ = Effect.objects.get_or_create(name="Information Superhighway", correspondence=2, time=3)
...
effect.save()
effect.add_source("Digital Web", 99)
effect, _ = Effect.objects.get_or_create(name="Instant Offline", correspondence=3, forces=2)
...
effect.save()
effect.add_source("Digital Web", 99)
effect, _ = Effect.objects.get_or_create(name="Parallax", correspondence=4, forces=2, mind=1)
...
effect.save()
effect.add_source("Digital Web", 98)
effect, _ = Effect.objects.get_or_create(name="Webcrawlers", correspondence=3, forces=3, prime=2)
...
effect, _ = Effect.objects.get_or_create(name="FOR NEXT Loop", correspondence=4, life=4, forces=2)
...
effect, _ = Effect.objects.get_or_create(name="Red Button", forces=3, entropy=3, prime=2)
...
effect, _ = Effect.objects.get_or_create(name="System Crash", correspondence=2, forces=2, prime=2)
...
effect.save()
effect.add_source("Digital Web", 99)
effect, _ = Effect.objects.get_or_create(name="Core Dump", correspondence=2, time=2, forces=3)
...
effect, _ = Effect.objects.get_or_create(name="Disk-Doctor", forces=1, entropy=3, mind=2)
...
effect.add_source("Mage: The Ascension (First Edition)", 206)
effect.add_source("Mage: The Ascension (Second Edition)", 210)
effect, _ = Effect.objects.get_or_create(name="Hacker's Glance", correspondence=1, entropy=2)
...
effect, _ = Effect.objects.get_or_create(name="Remote Access", correspondence=2, forces=2)
...
effect, _ = Effect.objects.get_or_create(name="Personal Assistant Software", mind=5, prime=2)
...
effect.save()
effect.add_source("Technocracy: Iteration X", 47)
effect, _ = Effect.objects.get_or_create(name="Book of Whispers", time=3, matter=3, mind=2)
...
effect, _ = Effect.objects.get_or_create(name="Eavesdropper", correspondence=2, forces=2)
...
effect.save()
effect.add_source("Hidden Lore", 19)
effect, _ = Effect.objects.get_or_create(name="High-Definition", correspondence=2, mind=2)
...
effect.save()
effect.add_source("Technocracy: Syndicate", 47)
effect, _ = Effect.objects.get_or_create(name="Squaring the Circle", correspondence=2, mind=1)
...
effect.save()
effect.add_source("Guide to the Technocracy", 205)
effect, _ = Effect.objects.get_or_create(name="Adad", correspondence=2, spirit=1, entropy=2)
...
effect, _ = Effect.objects.get_or_create(name="Chaos Butterfly", spirit=2, entropy=2, prime=2)
...
effect, _ = Effect.objects.get_or_create(name="Find the Lost", correspondence=1, entropy=2)
...
effect, _ = Effect.objects.get_or_create(name="Istar", correspondence=3, spirit=3, entropy=4)
...
effect.save()
effect.add_source("Dead Magic", 54)
effect, _ = Effect.objects.get_or_create(name="Laying on of Hands", time=2, life=1, entropy=1)
...
effect.save()
effect.add_source("Dead Magic", 54)
effect, _ = Effect.objects.get_or_create(name="Search Engine", correspondence=2, entropy=1, prime=1)
...
effect, _ = Effect.objects.get_or_create(name="Silent Promise of the Spring Tortoise", entropy=1)
...
effect.save()
effect.add_source("Dead Magic", 54)
effect, _ = Effect.objects.get_or_create(name="Wyrd Visions", correspondence=2, time=2, entropy=1)
...
effect.description = "Like Binding Oath, though Mind allows the mage to force it upon the target."
effect.save()
...
effect, _ = Effect.objects.get_or_create(name="Sparrow's Fall", time=4, entropy=3, prime=2)
...
effect.save()
effect.add_source("Dead Magic", 54)
effect, _ = Effect.objects.get_or_create(name="Biometric Holographic Recreation", time=2, forces=2)
...
effect, _ = Effect.objects.get_or_create(name="Don't Cross the Streams", correspondence=2, time=2)
...
effect.description = "The mage slaughters an animal and can read the future in its liver."
effect.save()
effect.add_source("Dead Magic 2", 143)
...
effect.save()
effect.add_source("Convention Book: New World Order (Revised)", 86)
effect, _ = Effect.objects.get_or_create(name="Long-Range Eyes", correspondence=2, time=2, mind=1)
effect.description = (
    "The mage can look at any given place or time and follow a given target forward or backwards."
)
effect.save()
...
effect.description = (
    "The mage can look backwards in time at any location, whether they are there or not."
)
effect.save()
...
effect.description = (
    "This allows the mage to view a location and look backwards in time, as though rewinding."
)
effect.save()
...
effect.save()
effect.add_source("Book of Crafts", 103)
effect, _ = Effect.objects.get_or_create(name="Reading the Umbral Skein", time=2, spirit=2, mind=1)
...
effect, _ = Effect.objects.get_or_create(name="Running Scenarios", time=2, entropy=2, mind=4)
...
effect.description = "Like Postcognition, but it involves viewing the future rather than the past."
effect.save()
effect.add_source("Mage: The Ascension (First Edition)", 218)
effect.add_source("Mage: The Ascension (Second Edition)", 223)
effect, _ = Effect.objects.get_or_create(name="Strategic Inefficiency Analysis", time=2, entropy=2)
...
effect.save()
effect.add_source("Mage: The Ascension (First Edition)", 228)
effect, _ = Effect.objects.get_or_create(name="Turning the Wheel of Ages", time=2, spirit=1, mind=3)
...
effect, _ = Effect.objects.get_or_create(name="View the Scattered Lotus Petals", time=2, entropy=1)
...
effect, _ = Effect.objects.get_or_create(name="Auric Trail", correspondence=1, spirit=1, prime=1)
...
effect, _ = Effect.objects.get_or_create(name="Correspondence Sensing", correspondence=2)
...
effect, _ = Effect.objects.get_or_create(name="Heat Seeking", correspondence=2, life=1, forces=1)
...
effect, _ = Effect.objects.get_or_create(name="Map the True Way", correspondence=2, matter=2)
...
effect, _ = Effect.objects.get_or_create(name="Scan Non-Local Universe", correspondence=2, spirit=2)
effect.description = "This allows the Void Engineers to perceive any location in the Umbra."
effect.save()
...
effect, _ = Effect.objects.get_or_create(name="Yao Su Dragon Thunder", spirit=2, forces=3, prime=2)
...
effect.save()
effect.add_source("Book of Crafts", 74)
effect, _ = Effect.objects.get_or_create(name="TWACI", correspondence=3, forces=3, mind=2)
...
effect.description = (
    "This rote causes the static electricity in the air to discharge, attacking a target."
)
effect.save()
effect.add_source("Mage: The Ascension (First Edition)", 195)
effect.add_source("Mage: The Ascension (Second Edition)", 198)
...
effect, _ = Effect.objects.get_or_create(name="Pulse of the Electro-Stream", forces=3, prime=2)
...
effect, _ = Effect.objects.get_or_create(name="Devouring Gullet of Flame", forces=4, prime=2)
...
effect.save()
effect.add_source("Blood Treachery", 88)
effect, _ = Effect.objects.get_or_create(name="Hermes' Brand", time=4, forces=3, entropy=1, prime=2)
...
effect.description = (
    "Converts all the light and sound in an area into heat, causing it to burst into flame."
)
effect.save()
effect.add_source("Mage: The Ascension (Revised)", 167)
...
effect.save()
effect.add_source("Book of Crafts", 119)
effect, _ = Effect.objects.get_or_create(name="Phlogiston Manipulation", life=3, forces=3, prime=2)
...
effect, _ = Effect.objects.get_or_create(name="Pop Goes the Weasel", life=3, forces=2, prime=2)
...
effect, _ = Effect.objects.get_or_create(name="Proof Against Immolation", matter=3, prime=2)
...
effect, _ = Effect.objects.get_or_create(name="Shih-Huang-Ti's Marvelous Game", life=3, forces=2)
...
effect.description = (
    "A stronger version of Laser Enhancement, this causes the laser to do aggravated damage."
)
effect.save()
effect.add_source("Technocracy: Void Engineers", 42)
effect, _ = Effect.objects.get_or_create(name="Tsuiho - The Fires of Heaven", correspondence=4)
effect.description = "The Wu Lung can truly show their enemies the power of heaven."
effect.save()
effect.add_source("Dragons of the East", 60)
effect, _ = Effect.objects.get_or_create(name="'Ahiu Nalu (Rogue Wave)", forces=2, entropy=2)
...
effect.save()
effect.add_source("Dead Magic 2", 26)
effect, _ = Effect.objects.get_or_create(name="Calling the Wind Lords", spirit=2, forces=2)
...
effect.save()
effect.add_source("Tradition Book: Verbena (First Edition)", 64)
effect, _ = Effect.objects.get_or_create(name="Dowsing", correspondence=2, matter=1, forces=2)
...
effect.description = "This rote converts water directly to steam, scalding anyone caught in it."
effect.save()
...
effect.add_source("Mage: The Ascension Revised", 167)
effect.add_source("Dead Magic 2", 103)
effect, _ = Effect.objects.get_or_create(name="Cold Water's Blessing", matter=2, prime=2)
...
effect, _ = Effect.objects.get_or_create(name="Awaken the Sleeping Earth", matter=3, prime=3)
...
effect, _ = Effect.objects.get_or_create(name="Prime Location", correspondence=1, prime=1)
...
effect, _ = Effect.objects.get_or_create(name="The Burning Lotus", forces=3, entropy=4, prime=5)
...
effect.save()
effect.add_source("Mage: The Ascension Revised", 185)
effect, _ = Effect.objects.get_or_create(name="The Hand of the Siphoner", matter=1, prime=3)
...
effect.save()
effect.add_source("Book of Chantries", 149)
effect, _ = Effect.objects.get_or_create(name="Hymn of Beatific Harmony", correspondence=3, prime=3)
...
effect.add_source("Convention Book: Progenitors (Revised)", 74)
effect, _ = Effect.objects.get_or_create(name="Radiate Prime Energy", entropy=2, prime=3)
...
effect.add_source("Mage: The Ascension First Edition", 210)
effect.add_source("Mage: The Ascension Second Edition", 214)
effect, _ = Effect.objects.get_or_create(name="Spinning Thread", spirit=2, forces=3, prime=2)
...
effect, _ = Effect.objects.get_or_create(name="Delay Paradox", time=3, spirit=3, prime=3)
...
effect.save()
effect.add_source("Mage: The Ascension Revised", 185)
effect, _ = Effect.objects.get_or_create(name="Penance for the Sicarii", correspondence=3, prime=4)
...
effect, _ = Effect.objects.get_or_create(name="Blood for the Gods", spirit=3, life=2, prime=1)
...
effect, _ = Effect.objects.get_or_create(name="Sense the Echo of the Dragon", time=2, mind=3)
...
effect.save()
effect.add_source("Mage: The Ascension First Edition", 226)
effect, _ = Effect.objects.get_or_create(name="Spearcatcher Rune", correspondence=1, time=3)
...
effect, _ = Effect.objects.get_or_create(name="Time-Motion Study", correspondence=1, time=1)
...
effect.save()
effect.add_source("Technocracy: Iteration X", 49)
effect, _ = Effect.objects.get_or_create(name="Wearing the Bear Shirt", spirit=4, life=3, mind=1)
...
effect.save()
effect.add_source("Order of Reason", 82)
effect, _ = Effect.objects.get_or_create(name="Battle Rune", correspondence=3, life=4, mind=3)
...
effect.save()
effect.add_source("Dead Magic 2", 99)
effect, _ = Effect.objects.get_or_create(name="Coordinated Fire", correspondence=1, time=1, mind=2)
...
effect, _ = Effect.objects.get_or_create(name="108 Plum Blossoms", correspondence=2, forces=2)
...
effect.save()
effect.add_source("Dragons of the East", 59)
effect, _ = Effect.objects.get_or_create(name="Arashi-Waza", correspondence=2, time=3, forces=2)
...
effect, _ = Effect.objects.get_or_create(name="The Final Blow", life=3, entropy=4, mind=5, prime=3)
...
effect.save()
effect.add_source("Tradition Book: Akashic Brotherhood (Revised)", 68)
effect, _ = Effect.objects.get_or_create(name="Flying Dragon Kick", correspondence=1, forces=4)
...
effect.add_source("Mage: The Ascension 20th Anniversary Edition", 601)
effect, _ = Effect.objects.get_or_create(name="Long Fist", correspondence=4, forces=3, prime=2)
...
effect.save()
effect.add_source("Tradition Book: Akashic Brotherhood (First Edition)", 64)
effect, _ = Effect.objects.get_or_create(name="Blade Sense", correspondence=1, matter=1, life=1)
...
effect.save()
effect.add_source("The Swashbuckler's Handbook", 91)
effect, _ = Effect.objects.get_or_create(name="Iron Snake", correspondence=2, forces=2, mind=3)
...
effect.description = "Increases a flintlock firearm's rate of fire by one turn per shot."
effect.save()
effect.add_source("Artisan's Handbook", 49)
...
effect, _ = Effect.objects.get_or_create(name="Conclave Wellness Works", life=1, entropy=2, mind=2)
...
effect.save()
effect.add_source("Guide to the Technocracy", 212)
effect, _ = Effect.objects.get_or_create(name="Drug Enhancement", matter=2, life=2, prime=1)
...
effect.save()
effect.add_source("Dead Magic 2", 27)
effect, _ = Effect.objects.get_or_create(name="Blight of Aging", life=4, entropy=4, prime=3)
...
effect.add_source("Mage: The Ascension (Second Edition)", 195)
effect.add_source("Mage: The Ascension (Revised)", 164)
effect, _ = Effect.objects.get_or_create(name="Bone Twisting Palm", life=4, entropy=4, prime=3)
...
effect, _ = Effect.objects.get_or_create(name="Destructive Genegineering", life=3, entropy=3)
...
effect.description = "The mage can brew a potion that causes anything it touches to wither and die."
effect.save()
...
effect.description = (
    "This allows the mage to attack the Pattern of a complex lifeform, such as a person, directly."
)
effect.save()
...
effect.save()
effect.add_source("Technocracy: Progenitors", 44)
effect, _ = Effect.objects.get_or_create(name="Spy's Stigmata", correspondence=1, life=2, prime=2)
...
effect, _ = Effect.objects.get_or_create(name="Distill the Azoth Elixir", matter=2, life=5, prime=3)
...
effect.save()
effect.add_source("Book of Crafts", 89)
effect, _ = Effect.objects.get_or_create(name="Hajjaj", correspondence=3, life=3, mind=2)
...
effect.save()
effect.add_source("Dead Magic", 29)
effect, _ = Effect.objects.get_or_create(name="Healing Slumber", spirit=2, life=3, mind=2)
...
effect.save()
effect.add_source("Order of Reason", 74)
effect, _ = Effect.objects.get_or_create(name="Trauma Transmission", correspondence=2, life=4)
...
effect.save()
effect.add_source("Dead Magic", 27)
effect, _ = Effect.objects.get_or_create(name="The Curse of Consequences", spirit=1, mind=3)
...
effect, _ = Effect.objects.get_or_create(name="Degree Absolute", correspondence=4, mind=5)
...
effect.description = "The mage causes any organic substance to become a potent explosive."
effect.save()
...
effect.add_source("Mage: The Ascension (Second Edition)", 206)
effect.add_source("Mage: The Ascension (Revised)", 173)
effect, _ = Effect.objects.get_or_create(name="Semi Auto CAD CAM", correspondence=5, matter=3)
...
effect.add_source("Mage: The Ascension (Second Edition)", 207)
effect, _ = Effect.objects.get_or_create(name="Transephemeration Ray Projector", matter=3, life=3)
...
effect, _ = Effect.objects.get_or_create(name="Perfection of the Tools", matter=1, mind=1)
...
effect.description = "Allows the mage to pull a small object to their location from elsewhere."
effect.save()
effect.add_source("Mage: The Ascension (Second Edition)", 189)
effect.add_source("Mage: The Ascension (Revised)", 159)
effect, _ = Effect.objects.get_or_create(
...
effect.save()
effect.add_source("Mage: The Ascension (First Edition)", 186)
effect, _ = Effect.objects.get_or_create(name="Spatial Sheath", correspondence=2, matter=1)
...
effect.save()
effect.add_source("Book of Crafts", 103)
effect, _ = Effect.objects.get_or_create(name="Summon Weapon", correspondence=2, matter=1)
...
effect.save()
effect.add_source("Tradition Book: Sons of Ether (Revised)", 61)
effect, _ = Effect.objects.get_or_create(name="Exotic Matter - Primium", matter=5, prime=3)
...
effect, _ = Effect.objects.get_or_create(name="Inscribe Amulet", time=4, matter=1, entropy=1)
...
effect, _ = Effect.objects.get_or_create(name="Na Kua's Gift", matter=3, forces=3, mind=3, prime=2)
...
effect.save()
effect.add_source("Guide to the Technocracy", 212)
effect, _ = Effect.objects.get_or_create(name="Spear of my Fathers", spirit=3, matter=3, prime=2)
...
effect.save()
effect.add_source("Mage: The Ascension (First Edition)", 225)
effect, _ = Effect.objects.get_or_create(name="Temple Pillars", matter=3, forces=4, prime=2)
...
effect.description = "This rote infuses entropy and chaos into an object, causing it to decay."
effect.save()
effect.add_source("Mage: The Ascension (First Edition)", 193)
...
effect.add_source("Mage: The Ascension (Second Edition)", 194)
effect.add_source("Mage: The Ascension (Revised)", 163)
effect, _ = Effect.objects.get_or_create(name="Tulugaak's Harpoon", matter=3, forces=3, prime=2)
...
effect.save()
effect.add_source("Mage Storyteller's Companion", 63)
effect, _ = Effect.objects.get_or_create(name="Talisman Tattoos", matter=4, life=3, prime=3)
...
effect.save()
effect.add_source("World of Darkness: Outcasts", 91)
effect, _ = Effect.objects.get_or_create(name="Talisman Transmogrification", matter=3, prime=3)
...
effect.save()
effect.add_source("Mage: The Ascension (First Edition)", 225)
effect, _ = Effect.objects.get_or_create(name="Walking Chair", spirit=4, matter=4, prime=2)
...
effect.save()
effect.add_source("Dead Magic", 57)
effect, _ = Effect.objects.get_or_create(name="Caffeine Plus", time=2, spirit=1, life=3, mind=1)
...
effect.description = "Allows the mage to refuel a Device with new quintessence from a Node."
effect.save()
effect.add_source("Order of Reason", 83)
...
effect.save()
effect.add_source("Order of Reason", 82)
effect, _ = Effect.objects.get_or_create(name="Back to the Earth", matter=4, life=3, prime=2)
...
effect.save()
effect.add_source("Dead Magic", 131)
effect, _ = Effect.objects.get_or_create(name="Degrade Order", correspondence=2, time=3, entropy=2)
...
effect.description = "The mage can break down structures by directly attacking their Patterns."
effect.save()
effect.add_source("Mage: The Ascension (First Edition)", 203)
effect.add_source("Mage: The Ascension (Second Edition)", 206)
effect.add_source("Mage: The Ascension (Revised)", 173)
...
effect.save()
effect.add_source("Mage: The Ascension (Revised)", 164)
effect, _ = Effect.objects.get_or_create(name="Night Battle", spirit=2, forces=3, mind=4, prime=2)
...
effect.save()
effect.add_source("Mage: The Sorcerer's Crusade", 271)
effect, _ = Effect.objects.get_or_create(name="We'll Get There", correspondence=1, entropy=2)
...
effect.save()
effect.add_source("Tradition Book: Hollow Ones (Revised)", 64)
effect, _ = Effect.objects.get_or_create(name="Ala Wai (Short Waters)", correspondence=3)
...
effect.save()
effect.add_source("Tradition Book: Verbena (First Edition)", 64)
effect, _ = Effect.objects.get_or_create(name="The Seven-League Stride", correspondence=3)
...
effect.save()
effect.add_source("Hidden Lore", 16)
effect, _ = Effect.objects.get_or_create(name="Thief in the Night", correspondence=1, forces=1)
...
effect, _ = Effect.objects.get_or_create(name="Chain of Whispers", correspondence=2, mind=3)
...
effect, _ = Effect.objects.get_or_create(name="Death Song", time=2, life=2, mind=1, prime=1)
...
effect, _ = Effect.objects.get_or_create(name="Dreamcry", correspondence=2, spirit=2, mind=2)
...
effect.save()
effect.add_source("Tradition Book: Dreamspeakers (First Edition)", 67)
effect, _ = Effect.objects.get_or_create(name="Dreamline", correspondence=2, time=2, mind=2)
...
effect, _ = Effect.objects.get_or_create(name="Public Posting", correspondence=2, mind=2, prime=2)
...
effect.save()
effect.add_source("Hidden Lore", 20)
effect, _ = Effect.objects.get_or_create(name="Sound/Thought Transfer", forces=2, mind=3)
...
effect.description = "The mage can transmit a single word or image into the target's subconscious."
effect.save()
effect.add_source("Mage: The Ascension (First Edition)", 206)
effect.add_source("Mage: The Ascension (Second Edition)", 210)
effect, _ = Effect.objects.get_or_create(name="Subliminal Transmission", correspondence=2, mind=2)
...
effect.save()
effect.add_source("Digital Web 2.0", 113)
effect, _ = Effect.objects.get_or_create(name="Temper Viasilicos", correspondence=2, mind=1)
...
effect, _ = Effect.objects.get_or_create(name="Tower of Babel/Speak in Tongues", forces=2, mind=2)
...
effect, _ = Effect.objects.get_or_create(name="What Did You Say?", correspondence=2, mind=2)
...
effect.save()
effect.add_source("Fallen Tower: Las Vegas", 119)
effect, _ = Effect.objects.get_or_create(name="Unravelling the Text", matter=2, entropy=2, prime=2)
...
effect.save()
effect.add_source("Book of Shadows", 142)
effect, _ = Effect.objects.get_or_create(name="Unseen Nomenclature", matter=2, mind=2, prime=2)
...
effect, _ = Effect.objects.get_or_create(name="Death's Passage", spirit=3, life=2, entropy=4)
...
effect, _ = Effect.objects.get_or_create(name="Presentation of the Passage Stick", spirit=3)
...
effect.save()
effect.add_source("Dead Magic 2", 65)
effect, _ = Effect.objects.get_or_create(name="Sense the Dreamsong", correspondence=1, spirit=1)
effect.description = (
    "This allows the mage to ascertain the boundaries and strength of the Dreamtime where they are."
)
effect.save()
effect.add_source("Dead Magic 2", 66)
effect, _ = Effect.objects.get_or_create(name="Sing the Dreaming Earth", spirit=5, mind=3, prime=5)
...
effect.save()
effect.add_source("Tradition Book: Hollow Ones (Revised)", 61)
effect, _ = Effect.objects.get_or_create(name="Daedalus Gateway", correspondence=4, mind=3)
...
effect.description = (
    "This allows a Void Engineer to teleport or, with Correspondence 4, to bring others with them."
)
effect.save()
effect.add_source("Technocracy: Void Engineers", 41)
...
effect.save()
effect.add_source("Mage: The Ascension (First Edition)", 227)
effect, _ = Effect.objects.get_or_create(name="Dreamquest", spirit=3, entropy=2, mind=2, prime=2)
...
effect, _ = Effect.objects.get_or_create(name="Gateway Transport", correspondence=5, spirit=5)
...
effect, _ = Effect.objects.get_or_create(name="Leap Sideways", correspondence=3, spirit=3)
...
effect.save()
effect.add_source("Mage: The Ascension (First Edition)", 227)
effect, _ = Effect.objects.get_or_create(name="Long-Distance Universal Travel", spirit=5)
...
effect.description = "This rote allows a shaman to strengthen or weaken the Gauntlet in an area."
effect.save()
effect.add_source("Technocracy: New World Order", 49)
effect.add_source("Tradition Book: Dreamspeakers (Revised)", 66)
...
effect.add_source("Mage: The Ascension (Revised)", 167)
effect, _ = Effect.objects.get_or_create(name="Sucking Gate", spirit=4, forces=4, prime=2)
...
effect.save()
effect.add_source("Tradition Book: Dreamspeakers (First Edition)", 67)
effect, _ = Effect.objects.get_or_create(name="Umbral Visions", correspondence=2, spirit=2, mind=1)
...
effect.save()
effect.add_source("Technocracy: Void Engineers", 42)
effect, _ = Effect.objects.get_or_create(name="Walking the Open Path", spirit=2, prime=1)
...
effect.save()
effect.add_source("Convention Book: Void Engineers (Revised)", 87)
effect, _ = Effect.objects.get_or_create(name="The Barrel of Iskander", matter=2, forces=1)
...
effect.save()
effect.add_source("Artisan's Handbook", 52)
effect, _ = Effect.objects.get_or_create(name="Format Space", correspondence=5, spirit=4)
...
effect.description = (
    "This allows the Wu Lung to levitate and move as quickly as if they were in the Umbra."
)
effect.save()
...
effect, _ = Effect.objects.get_or_create(name="Information Glut", correspondence=2, time=2, mind=1)
...
effect, _ = Effect.objects.get_or_create(name="Information Overload", correspondence=2, mind=2)
...
effect.add_source("Mage: The Ascension (Second Edition)", 189)
effect.add_source("Mage: The Ascension (Revised)", 159)
effect, _ = Effect.objects.get_or_create(name="Lay of the Land", correspondence=2, life=2)
...
effect.description = "By paying attention to the strands of Fate, the mage can detect lies."
effect.save()
effect.add_source("Mage: The Ascension (Second Edition)", 193)
effect.add_source("Mage: The Ascension (Revised)", 162)
effect, _ = Effect.objects.get_or_create(name="See the Soul's Burn", spirit=1, entropy=2, mind=1)
...
effect.description = "Allows the mage to sense how much energy and of what kinds are in the area."
effect.save()
effect.add_source("Mage: The Ascension (First Edition)", 195)
effect.add_source("Mage: The Ascension (Second Edition)", 198)
effect.add_source("Mage: The Ascension (Revised)", 166)
...
effect.description = "This Procedure scans (and stores) the genetic code of an individual."
effect.save()
...
effect.add_source("Mage: The Ascension (First Edition)", 198)
effect.add_source("Mage: The Ascension (Second Edition)", 201)
effect, _ = Effect.objects.get_or_create(name="Genome Mapping", correspondence=3, life=2)
...
effect.save()
effect.add_source("The Swashbuckler's Handbook", 92)
effect, _ = Effect.objects.get_or_create(name='Aai-ab "Washing the Heart"', spirit=1, mind=2)
...
effect.save()
effect.add_source("Fallen Tower: Las Vegas", 120)
effect, _ = Effect.objects.get_or_create(name="Ishin Den Shin", correspondence=2, mind=2)
effect.description = "Allows the Akashic to sense the emotions and mental state of those affected."
effect.save()
effect.add_source("Tradition Book: Akashic Brotherhood (Revised)", 77)
...
effect, _ = Effect.objects.get_or_create(name="Mindfulness of Wrong Thought", life=1, mind=2)
...
effect, _ = Effect.objects.get_or_create(name="Detect Reality Deviation", spirit=2, prime=1)
...
effect.save()
effect.add_source("Dead Magic 2", 100)
effect, _ = Effect.objects.get_or_create(name="Patterns of the Long Count", spirit=1, prime=1)
...
effect.save()
effect.add_source("Technocracy: New World Order", 48)
effect, _ = Effect.objects.get_or_create(name="Evaluate Fourth Dimensional Fabric", time=1)
effect.description = "This allows a Void Engineer to determine if time has been tampered with."
effect.save()
effect.add_source("Technocracy: Void Engineers", 46)
...
effect.save()
effect.add_source("Book of Crafts", 41)
effect, _ = Effect.objects.get_or_create(name="Blood from a Stone", spirit=4, life=3, mind=4)
...
effect, _ = Effect.objects.get_or_create(name="Voice of the Jade Ancestors", spirit=2, mind=2)
...
effect.save()
effect.add_source("Dead Magic", 30)
effect, _ = Effect.objects.get_or_create(name="Soul-Forging", spirit=4, matter=3, prime=3)
...
effect, _ = Effect.objects.get_or_create(name="Song of Orpheus", matter=2, life=4, mind=2, prime=2)
...
effect, _ = Effect.objects.get_or_create(name="Encrypt Thoughts", life=1, mind=1, prime=2)
...
effect.save()
effect.add_source("Technocracy: New World Order", 45)
effect, _ = Effect.objects.get_or_create(name="Secure the Scene", matter=1, forces=1, mind=2)
...
effect.save()
effect.add_source("Mage: The Ascension (Second Edition)", 210)
effect, _ = Effect.objects.get_or_create(name="Soul Cloak", spirit=3, entropy=2, mind=2, prime=2)
...
effect.description = (
    "The mage can bend space and probability around them, granting them temporary levels of Arcane."
)
effect.save()
effect.add_source("Initiates of the Art", 81)
effect, _ = Effect.objects.get_or_create(
...
effect.save()
effect.add_source("Hidden Lore", 18)
effect, _ = Effect.objects.get_or_create(name="Selective Edit", correspondence=2, entropy=2)
...
effect.save()
effect.add_source("Guide to the Technocracy", 206)
effect, _ = Effect.objects.get_or_create(name='Sjonhverfing ("Deceiving of the Sight")', mind=2)
...
effect.save()
effect.add_source("Tradition Book: Hollow Ones (Revised)", 62)
effect, _ = Effect.objects.get_or_create(name="Dreamer's Shroud from Day", correspondence=4)
...
effect.save()
effect.add_source("Mage: The Ascension (First Edition)", 223)
effect, _ = Effect.objects.get_or_create(name="Ariadne's Thread", correspondence=1, matter=1)
...
effect.description = "Chain allows a mage to strengthen or weaken the connections between objects."
effect.save()
effect.add_source("Mage: The Ascension (Second Edition)", 189)
effect.add_source("Mage: The Ascension (Revised)", 159)
...
effect.add_source("Mage: The Ascension (Second Edition)", 191)
effect.add_source("Mage: The Ascension (Revised)", 160)
effect, _ = Effect.objects.get_or_create(name="Simon's Petition", correspondence=4, mind=1)
...
effect.description = (
    "The mage can dilate time, speeding it up in a given area, as though fast-forwarding."
)
effect.save()
effect.add_source("Mage: The Ascension (First Edition)", 218)
effect.add_source("Mage: The Ascension (Second Edition)", 223)
...
effect, _ = Effect.objects.get_or_create(name="Establish Local Temporal Event Field", time=4)
effect.description = "This procedure pauses time around an individual or an object."
effect.save()
effect.add_source("Technocracy: Void Engineers", 46)
effect, _ = Effect.objects.get_or_create(name="The Frenzy of the Spinning Wheels", time=3)
effect.description = (
    "Allows the user to operate machinery that requires many simultaneous actions by themselves."
)
effect.save()
effect.add_source("Artisan's Handbook", 52)
effect, _ = Effect.objects.get_or_create(name="The Moment that Stretches", time=3, mind=1)
...
effect.save()
effect.add_source("Hidden Lore", 14)
effect, _ = Effect.objects.get_or_create(name="Nick of Time", correspondence=3, time=2, entropy=3)
...
effect.description = (
    "The opposite of Elemental Magick, Slow Time decreases the flow of time in a small area."
)
effect.save()
effect.add_source("Mage: The Ascension (First Edition)", 219)
effect.add_source("Mage: The Ascension (Second Edition)", 223)
...
effect.description = (
    "This effect speeds up the mage's reflexes, giving extra actions for successes after the first."
)
effect.save()
effect.add_source("Mage: The Sorcerer's Crusade", 272)
effect.add_source("The Swashbuckler's Handbook", 95)
...
effect.save()
effect.add_source("Mage: The Ascension (Revised)", 193)
effect, _ = Effect.objects.get_or_create(name="Tune In, Turn On, Drop Out", time=4, life=3)
...
effect.save()
effect.add_source("Mage: The Ascension (First Edition)", 228)
effect, _ = Effect.objects.get_or_create(name="Zen and the Art of Panhandling", time=5, prime=3)
...
effect.description = (
    "Like the Prime effect Wrath of God, except that it works against ghosts and spirits."
)
effect.save()
effect.add_source("Order of Reason", 85)
effect, _ = Effect.objects.get_or_create(
...
effect.save()
effect.add_source("Infinite Tapestry", 183)
effect, _ = Effect.objects.get_or_create(name="Spirit Eating", spirit=2, mind=3, prime=3)
...
effect, _ = Effect.objects.get_or_create(name="Bottle of Djinn", spirit=4, matter=3, prime=2)
...
effect.description = "Hermetics have used this rote for centuries to force a spirit to materialize."
effect.save()
effect.add_source("Tradition Book: Order of Hermes (First Edition)", 65)
...
effect.add_source("Mage: The Ascension (First Edition)", 215)
effect.add_source("Mage: The Ascension (Second Edition)", 218)
effect, _ = Effect.objects.get_or_create(name="Halt the Nagloper", time=2, matter=2, life=2)
...
effect.description = (
    "Given a body with no spirit in it, this allows the mage to bind a spirit to it as a Familiar."
)
effect.save()
effect.add_source("Mage: The Ascension (First Edition)", 224)
effect, _ = Effect.objects.get_or_create(name="Lesser Binding of Spirits", spirit=2, prime=2)
...
effect.save()
effect.add_source("Mage: The Ascension (Second Edition)", 219)
effect, _ = Effect.objects.get_or_create(name="Lull the Waking Dreamborn", spirit=2, mind=3)
...
effect.save()
effect.add_source("Dead Magic 2", 65)
effect, _ = Effect.objects.get_or_create(name="Physical Exorcism", spirit=4, life=3, prime=2)
...
effect.add_source("Mage: The Ascension (Second Edition)", 217)
effect.add_source("Mage: The Ascension (Revised)", 187)
effect, _ = Effect.objects.get_or_create(name="Evaluate Gauntlet/Scan Locality", spirit=1)
effect.description = (
    "This allows the Void Engineer to check the strength of the Gauntlet in a given location."
)
effect.save()
effect.add_source("Technocracy: Void Engineers", 41)
effect, _ = Effect.objects.get_or_create(name="Sense the Demon's Weakness", spirit=1, entropy=1)
effect.description = (
    "This allows a Wu Lung to focus on a demon and determine the essential weakness of its nature."
)
effect.save()
effect.add_source("Book of Crafts", 135)
effect, _ = Effect.objects.get_or_create(name="Sense the Nagloper", time=2, matter=1, life=2)
...
effect.save()
effect.add_source("Book of Shadows", 143)
effect, _ = Effect.objects.get_or_create(name='Ap-Sobk "The Last Judgment of Sobk"', spirit=4)
...
effect.save()
effect.add_source("Book of Crafts", 58)
effect, _ = Effect.objects.get_or_create(name="Call Forth the Forgotten", spirit=2, life=5, prime=2)
...
effect, _ = Effect.objects.get_or_create(name="Here Kitty, Kitty", correspondence=3, time=3, mind=3)
...
effect.save()
effect.add_source("Hidden Lore", 52)
effect, _ = Effect.objects.get_or_create(name="Protection of the Golden Race", spirit=5, prime=2)
...
effect.save()
effect.add_source("Book of Shadows", 146)
effect, _ = Effect.objects.get_or_create(name="Satan's Song", spirit=2, forces=2, mind=2, prime=3)
...
effect.save()
effect.add_source("Dead Magic", 131)
effect, _ = Effect.objects.get_or_create(name="Spirit Roster", correspondence=2, spirit=1)
effect.description = (
...
effect.save()
effect.add_source("Dragons of the East", 59)
effect, _ = Effect.objects.get_or_create(name="Visionary Bloodletting", spirit=2, mind=1)
...
effect.add_source("Technocracy: New World Order", 44)
effect.add_source("Convention Book: New World Order (Revised)", 87)
effect, _ = Effect.objects.get_or_create(name="Defense Screen vs. Higher Lifeforms", life=3)
...
effect.save()
effect.add_source("Technocracy: Void Engineers", 43)
effect, _ = Effect.objects.get_or_create(name="Defense Screen vs. Lower Lifeforms", life=2)
effect.description = (
...
effect.save()
effect.add_source("Mage Storyteller's Companion", 63)
effect, _ = Effect.objects.get_or_create(name="Protection Song", correspondence=4, forces=2)
effect.description = (
    "This rote combines Ward and Energy Shield and with Spirit, extends to the Umbra as well."
)
effect.save()
effect.add_source("Dead Magic 2", 126)
...
effect, _ = Effect.objects.get_or_create(name="Quantum Interference Shielding", correspondence=2)
...
effect.save()
effect.add_source("Technocracy: Void Engineers", 42)
effect, _ = Effect.objects.get_or_create(name="Repel the Hungry Dead", spirit=4, prime=2)
effect.description = "This creates a spiritual barrier around the Wu Lung that prevents possession."
effect.save()
effect.add_source("Book of Crafts", 135)
...
effect.save()
effect.add_source("Dragons of the East", 59)
effect, _ = Effect.objects.get_or_create(name="Safe Little World", correspondence=4, life=3)
...
effect.save()
effect.add_source("Orphan's Survival Guide", 129)
effect, _ = Effect.objects.get_or_create(name="Salt on the Earth", correspondence=4, entropy=1)
...
effect.save()
effect.add_source("Tradition Book: Euthanatos (Revised)", 66)
effect, _ = Effect.objects.get_or_create(name="Secret Labyrinth", spirit=4, mind=3, prime=2)
...
effect.save()
effect.add_source("Dragons of the East", 66)
effect, _ = Effect.objects.get_or_create(name="Wall of Mirrors", correspondence=4, forces=3)
...
effect.save()
effect.add_source("Book of Shadows", 140)
effect, _ = Effect.objects.get_or_create(name="War of the Inner Sanctum", correspondence=4, life=3)
effect.description = (
...
effect.save()
effect.add_source("Order of Reason", 73)
effect, _ = Effect.objects.get_or_create(name="Uther's Butchered Visage", life=3, mind=1)
...
effect.save()
effect.add_source("Technocracy: Progenitors", 43)
effect, _ = Effect.objects.get_or_create(name="Attach Biomechanism", matter=5, life=3, prime=3)
...
effect.description = (
    "The targets bones are rendered brittle and weak, reducing their soak dice by one per success."
)
effect.save()
effect.add_source("World of Darkness: Outcasts", 90)
...
effect.save()
effect.add_source("Technocracy: Progenitors", 43)
effect, _ = Effect.objects.get_or_create(name="Graft Alien Bio-Matter Between Aliens", life=3)
...
effect.save()
effect.add_source("Technocracy: Progenitors", 41)
effect, _ = Effect.objects.get_or_create(name="Graft Alien Bio-Matter to Humans", life=4)
...
effect.save()
effect.add_source("Book of Crafts", 88)
effect, _ = Effect.objects.get_or_create(name="Higher Lifeform Grafting and Recombination", life=4)
...
effect.save()
effect.add_source("Technocracy: Progenitors", 40)
effect, _ = Effect.objects.get_or_create(name="Limited Grafting and Recombination", life=3)
...
effect.save()
effect.add_source("Technocracy: Progenitors", 40)
effect, _ = Effect.objects.get_or_create(name="Major Environmental Alteration", matter=3)
...
effect.save()
effect.add_source("Technocracy: Void Engineers", 44)
effect, _ = Effect.objects.get_or_create(name="Minor Environmental Alteration", matter=2)
...
effect.save()
effect.add_source("Technocracy: Void Engineers", 44)
effect, _ = Effect.objects.get_or_create(name="Mokupuni Palahalaha Wiki", time=3, life=2, prime=3)
...
effect.add_source("Mage: The Ascension (First Edition)", 199)
effect.add_source("Mage: The Ascension (Second Edition)", 202)
effect, _ = Effect.objects.get_or_create(name="Personal Compression", correspondence=5, life=3)
...
effect.save()
effect.add_source("Technocracy: Progenitors", 40)
effect, _ = Effect.objects.get_or_create(name="Courtesan's Draught/Blessed Heir", life=2)
...
effect.save()
effect.add_source("Tradition Book: Verbena (Revised)", 66)
effect, _ = Effect.objects.get_or_create(name="Deity Form", spirit=2, life=4, forces=3, prime=4)
...
effect, _ = Effect.objects.get_or_create(name="Iron Avatar", matter=3, life=3, mind=2, prime=2)
...
effect.add_source("Tradition Book: Euthanatos (First Edition)", 67)
effect.add_source("Tradition Book: Euthanatos (Revised)", 60)
effect, _ = Effect.objects.get_or_create(name="Jaguar Cloak", spirit=2, matter=3, life=5, prime=3)
...
effect.add_source("Mage: The Ascension (Second Edition)", 203)
effect.add_source("Mage: The Ascension (Revised)", 171)
effect, _ = Effect.objects.get_or_create(name="The Notorious Vampiric Lawnchair", matter=5, life=5)
...
effect, _ = Effect.objects.get_or_create(name="Vulcan's Hammer", matter=3, life=4, forces=3)
...
effect.description = (
    "This is the Mental equivalent of Better Body, allowing the increase of Mental Attributes."
)
effect.save()
effect.add_source("Digital Web 2.0", 114)
...
effect.add_source("Mage: The Ascension (First Edition)", 205)
effect.add_source("Mage: The Ascension (Second Edition)", 209)
effect, _ = Effect.objects.get_or_create(name="Nanotech Integration", matter=2, life=4, prime=5)
...
effect.add_source("Convention Book: Progenitors (Revised)", 74)
effect, _ = Effect.objects.get_or_create(name="Our Enemies are Delicious", spirit=3, life=3)
...
effect.description = "Each success adds one dot to any Mental Attribute for the duration."
effect.save()
effect.add_source("Technocracy: Iteration X", 48)
...
effect.description = (
    "Allows the mage to temporarily gain dots in Strength, Dexterity, Stamina and/or Appearance."
)
effect.save()
effect.add_source("Mage: The Sorcerer's Crusade", 273)
...
effect.save()
effect.add_source("Order of Reason", 79)
effect, _ = Effect.objects.get_or_create(name="Pass Calmly", correspondence=2, life=1, mind=2)
...
effect.description = (
    "This rote allows the user to attempt to cow the target into submission through intimidation."
)
effect.save()
effect.add_source("Order of Reason", 79)
...
effect.description = "This rote allows the user to taunt a target to try to goad them into a fight."
effect.save()
effect.add_source("Order of Reason", 79)
...
effect.save()
effect.add_source("Technocracy: Iteration X", 48)
effect, _ = Effect.objects.get_or_create(name="Strains of Laughter, Sleep and Sorrow", mind=2)
...
effect, _ = Effect.objects.get_or_create(name="Ratstorm", correspondence=2, life=2, mind=2)
...
effect.save()
effect.add_source("Orphan's Survival Guide", 125)
effect, _ = Effect.objects.get_or_create(name="Sedna's Blessing", correspondence=2, mind=2)
...
effect.description = "This rote creates an aura around the mage that draws all eyes to them."
effect.save()
effect.add_source("Mage: The Sorcerer's Crusade", 270)
effect, _ = Effect.objects.get_or_create(name="Fifteen Minutes", correspondence=3, mind=2)
...
effect, _ = Effect.objects.get_or_create(name="Magdeline's Dynamic Mind", entropy=2, mind=3)
...
effect.save()
effect.add_source("Technocracy: New World Order", 49)
effect, _ = Effect.objects.get_or_create(name="Painting the War Dance", matter=2, mind=2)
...
effect.save()
effect.add_source("Dead Magic", 29)
effect, _ = Effect.objects.get_or_create(name="Behavior Modification Device", entropy=3, mind=4)
effect.description = (
...
effect.description = "With Manipulate Memory, the mage can alter the memories of the target."
effect.save()
effect.add_source("Mage: The Ascension (First Edition)", 207)
effect.add_source("Mage: The Ascension (Second Edition)", 211)
effect.add_source("Mage: The Ascension (Revised)", 178)
...
effect.description = "This procedure transfers memories from one individual into a blank mind."
effect.save()
effect.add_source("Technocracy: Progenitors", 42)
...
effect, _ = Effect.objects.get_or_create(name="The Blissful Discipline", forces=3, mind=4, prime=2)
...
effect.add_source("Technocracy: Void Engineers", 45)
effect.add_source("Convention Book: Void Engineers (Revised)", 85)
effect, _ = Effect.objects.get_or_create(name="Destructive Paranoia", entropy=2, mind=4, prime=2)
...
effect.save()
effect.add_source("Guide to the Technocracy", 215)
effect, _ = Effect.objects.get_or_create(name="Internal Obligation", time=4, mind=4, prime=3)
...
effect.description = "Puts a target who wants to sleep, at least a little bit, to sleep."
effect.save()
effect.add_source("The Swashbuckler's Handbook", 93)
...
effect.save()
effect.add_source("Book of Crafts", 103)
effect, _ = Effect.objects.get_or_create(name="Re-education Mode", time=3, mind=4, prime=2)
...
effect_save_state = Effect.objects.get_or_create(name="Save State", mind=3, time=2, prime=2)[
    0
].add_source("Lore of the Traditions", 162)
...
effect_summon_powerful_ghost = Effect.objects.get_or_create(name="Summon Powerful Ghost", spirit=3)[
    0
...
effect_speak_with_dead = Effect.objects.get_or_create(name="Speak with Dead", spirit=2, mind=1)[
    0
].add_source("How Do You Do That", 142)
...
effect_banish_ghost = Effect.objects.get_or_create(name="Banish Ghost", spirit=3, prime=2)[
    0
...
effect_see_future_distant = Effect.objects.get_or_create(name="See Future (Distant)", time=3)[
    0
].add_source("How Do You Do That", 154)
...
effect_speed_time_local = Effect.objects.get_or_create(name="Speed Time (Local)", time=3)[
    0
].add_source("How Do You Do That", 155)
...
effect_stop_time_large_area = Effect.objects.get_or_create(name="Stop Time (Large Area)", time=5)[
    0
].add_source("How Do You Do That", 155)
...
effect_create_time_loop = Effect.objects.get_or_create(name="Create Time Loop", time=4, prime=2)[
    0
...
effect_clone_body = Effect.objects.get_or_create(name="Clone Body", life=5, prime=2, mind=1)[
    0
...
effect_age_de_age_target = Effect.objects.get_or_create(name="Age/De-Age Target", life=4, time=2)[
    0
...
# ===== ADVANCED MIND MAGIC =====
effect_read_surface_thoughts = Effect.objects.get_or_create(name="Read Surface Thoughts", mind=2)[
    0
...
effect_implant_false_memory = Effect.objects.get_or_create(name="Implant False Memory", mind=4)[
    0
].add_source("Mage: The Ascension 20th Anniversary Edition", 519)
...
effect_mind_control_complex = Effect.objects.get_or_create(name="Mind Control (Complex)", mind=4)[
    0
].add_source("Mage: The Ascension 20th Anniversary Edition", 519)
...
effect_astral_quest = Effect.objects.get_or_create(name="Astral Quest", mind=5, spirit=3)[
    0
].add_source("Mage: The Ascension 20th Anniversary Edition", 519)
...
effect_flight_self = Effect.objects.get_or_create(name="Flight (Self)", forces=2, life=2)[
    0
].add_source("How Do You Do That", 126)

effect_flight_others = Effect.objects.get_or_create(name="Flight (Others)", forces=3, life=2)[
    0
].add_source("How Do You Do That", 126)
...
effect_laser_blast = Effect.objects.get_or_create(name="Laser Blast", forces=3, matter=2)[
    0
...
effect_nuclear_blast = Effect.objects.get_or_create(name="Nuclear Blast", forces=5, prime=4)[
    0
].add_source("Mage: The Ascension 20th Anniversary Edition", 517)
...
effect_disintegrate_object = Effect.objects.get_or_create(name="Disintegrate Object", matter=4)[
    0
].add_source("Mage: The Ascension 20th Anniversary Edition", 518)

effect_turn_to_stone = Effect.objects.get_or_create(name="Turn to Stone", matter=3, life=3)[
    0
].add_source("Mage: The Ascension 20th Anniversary Edition", 518)

# ===== ADVANCED ENTROPY =====
effect_curse_of_bad_luck = Effect.objects.get_or_create(name="Curse of Bad Luck", entropy=3)[
    0
...
effect_rot_living_being = Effect.objects.get_or_create(name="Rot Living Being", entropy=4, life=2)[
    0
].add_source("Mage: The Ascension 20th Anniversary Edition", 516)

effect_shatter_pattern = Effect.objects.get_or_create(name="Shatter Pattern", entropy=5, prime=2)[
    0
].add_source("Mage: The Ascension 20th Anniversary Edition", 516)
...
effect_enchant_talisman = Effect.objects.get_or_create(name="Enchant Talisman", prime=3)[
    0
...
effect_disenchant_wonder = Effect.objects.get_or_create(name="Disenchant Wonder", prime=4)[
    0
...
effect_open_seal_node = Effect.objects.get_or_create(name="Open/Seal Node", prime=4, spirit=2)[
    0
].add_source("Mage: The Ascension 20th Anniversary Edition", 520)
...
effect_touch_spirit_matter = Effect.objects.get_or_create(name="Touch Spirit Matter", spirit=2)[
    0
...
effect_reach_into_umbra = Effect.objects.get_or_create(name="Reach Into Umbra", spirit=3)[
    0
].add_source("Mage: The Ascension 20th Anniversary Edition", 521)

effect_summon_spirit_minor = Effect.objects.get_or_create(name="Summon Spirit (Minor)", spirit=2)[
    0
...
effect_create_spirit = Effect.objects.get_or_create(name="Create Spirit", spirit=5, prime=4)[
    0
].add_source("Mage: The Ascension 20th Anniversary Edition", 521)
...
effect_harm_werewolf = Effect.objects.get_or_create(name="Harm Werewolf", life=3, spirit=3)[
    0
].add_source("Gods & Monsters", 75)

effect_heal_werewolf = Effect.objects.get_or_create(name="Heal Werewolf", life=3, spirit=2)[
    0
].add_source("Gods & Monsters", 75)
...
effect_strengthen_ghost = Effect.objects.get_or_create(name="Strengthen Ghost", spirit=3, prime=2)[
    0
].add_source("Gods & Monsters", 120)
...
# Cult of Ecstasy
effect_temporal_fugue = Effect.objects.get_or_create(name="Temporal Fugue", time=3, mind=2)[
    0
].add_source("Lore of the Traditions", 68)

effect_ecstatic_vision = Effect.objects.get_or_create(name="Ecstatic Vision", mind=2, time=1)[
    0
].add_source("Lore of the Traditions", 68)
...
effect_call_totem_spirit = Effect.objects.get_or_create(name="Call Totem Spirit", spirit=4)[
    0
...
effect_wheel_of_fate = Effect.objects.get_or_create(name="Wheel of Fate", entropy=4, time=2)[
    0
].add_source("Lore of the Traditions", 108)
...
effect_reality_cancer = Effect.objects.get_or_create(name="Reality Cancer", prime=5, entropy=5)[
    0
].add_source("Book of the Fallen", 155)

# ===== UTILITY & MISCELLANEOUS =====
effect_permanent_enchantment = Effect.objects.get_or_create(name="Permanent Enchantment", prime=5)[
    0
].add_source("Mage: The Ascension 20th Anniversary Edition", 520)

effect_counterspell_basic = Effect.objects.get_or_create(name="Counterspell (Basic)", prime=2)[
    0
].add_source("Mage: The Ascension 20th Anniversary Edition", 542)
...
effect_dispel_paradox = Effect.objects.get_or_create(name="Dispel Paradox", prime=3, entropy=2)[
    0
].add_source("Mage: The Ascension 20th Anniversary Edition", 548)
