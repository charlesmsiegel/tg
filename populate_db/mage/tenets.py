...
a_rational_universe = Tenet.objects.get_or_create(name="A Rational Universe", tenet_type="met")[
    0
...
as_above_so_below = Tenet.objects.get_or_create(name="As Above, So Below", tenet_type="met")[
    0
].add_source("Prism of Focus", 16)
as_above_so_below.associated_practices.add(alchemy, dominion, faith, highritualmagick, witchcraft)
...
fall_from_grace.limited_practices.add(hypertech, invigoration, medicinework, realityhacking, yoga)
reality_is_a_lie = Tenet.objects.get_or_create(name="Reality is a Lie", tenet_type="met")[
    0
].add_source("Prism of Focus", 16)
reality_is_a_lie.associated_practices.add(bardism, chaosmagick, crazywisdom, martialarts, yoga)
reality_is_a_lie.limited_practices.add(
    craftwork, cybernetics, elementalism, highritualmagick, weirdscience
)
the_divine_is_real = Tenet.objects.get_or_create(name="The Divine is Real", tenet_type="met")[
    0
].add_source("Prism of Focus", 16)
the_divine_is_real.associated_practices.add(faith, godbonding, invigoration, witchcraft, yoga)
...
i_am_chosen = Tenet.objects.get_or_create(name="I Am Chosen", tenet_type="per")[0].add_source(
    "Prism of Focus", 16
)
...
i_am_not_limited = Tenet.objects.get_or_create(name="I Am Not Limited", tenet_type="per")[
    0
...
i_am_special = Tenet.objects.get_or_create(name="I Am Special", tenet_type="per")[0].add_source(
    "Prism of Focus", 17
)
i_am_special.associated_practices.add(bardism, dominion, elementalism, psionics, shamanism)
...
i_have_greater_understanding.limited_practices.add(bardism, godbonding, guttermagick, psionics)
...
annihilation_is_freedom.associated_practices.add(chaosmagick, guttermagick, maleficia, martialarts)
annihilation_is_freedom.limited_practices.add(
    animalism, artofdesire, craftwork, elementalism, medicinework
)
build_a_utopia = Tenet.objects.get_or_create(name="Build a Utopia", tenet_type="asc")[0].add_source(
    "Prism of Focus", 18
)
...
merge_with_the_divine = Tenet.objects.get_or_create(name="Merge With the Divine", tenet_type="asc")[
    0
...
merge_with_the_divine.limited_practices.add(chaosmagick, cybernetics, hypertech, weirdscience)
power_is_its_own_reward = Tenet.objects.get_or_create(
    name="Power is its Own Reward", tenet_type="asc"
)[0].add_source("Prism of Focus", 18)
power_is_its_own_reward.associated_practices.add(artofdesire, dominion, highritualmagick, maleficia)
power_is_its_own_reward.limited_practices.add(crazywisdom, faith, shamanism, voudoun, yoga)
i_illuminate = Tenet.objects.get_or_create(name="I Illuminate", tenet_type="oth")[0].add_source(
    "Prism of Focus", 18
)
i_illuminate.associated_practices.add(alchemy, charity, faith, highritualmagick, hypertech)
i_illuminate.limited_practices.add(animalism, appropriation, maleficia, mediacontrol, psionics)
i_rule = Tenet.objects.get_or_create(name="I Rule", tenet_type="oth")[0].add_source(
    "Prism of Focus", 18
)
i_rule.associated_practices.add(alchemy, artofdesire, dominion, highritualmagick, mediacontrol)
...
i_serve.limited_practices.add(alchemy, artofdesire, dominion, highritualmagick, mediacontrol)
mystical_insights = Tenet.objects.get_or_create(name="Mystical Insights", tenet_type="oth")[
    0
...
divine_revelations = Tenet.objects.get_or_create(name="Divine Revelations", tenet_type="oth")[
    0
].add_source("Prism of Focus", 19)
divine_revelations.associated_practices.add(crazywisdom, faith, godbonding, maleficia, shamanism)
...
hierarchical_paradigm = Tenet.objects.get_or_create(name="Hierarchical Paradigm", tenet_type="oth")[
    0
].add_source("Prism of Focus", 19)
hierarchical_paradigm.associated_practices.add(dominion, godbonding, martialarts, weirdscience)
hierarchical_paradigm.limited_practices.add(
    chaosmagick, cybernetics, faith, highritualmagick, hypertech
)
open_paradigm = Tenet.objects.get_or_create(name="Open Paradigm", tenet_type="oth")[0].add_source(
    "Prism of Focus", 19
)
...
reincarnation = Tenet.objects.get_or_create(name="Reincarnation", tenet_type="oth")[0].add_source(
    "Prism of Focus", 19
)
...
yolo.limited_practices.add(chaosmagick, crazywisdom, martialarts, shamanism, witchcraft, yoga)
