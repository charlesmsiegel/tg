# Mage-Specific Spirit Characters
# Includes Paradox Spirits, Umbrood, Elementals, and other spirit entities from Mage sourcebooks

from characters.models.werewolf.charm import SpiritCharm
from characters.models.werewolf.spirit_character import SpiritCharacter

# ===== PARADOX SPIRITS =====
# Paradox Spirits hunt reality deviants and punish vulgar magic
...
# ===== ELEMENTAL SPIRITS =====
# Elemental Spirits embody primal forces
...
# Spirits that embody abstract concepts
...
# ===== NODE GUARDIANS =====
# Spirits that guard sacred places and nodes
...
# ===== AVATAR SPIRITS =====
# Spirits connected to mage Avatars
...
# ===== TECHNOCRATIC CONSTRUCTS (SPIRITUAL) =====
# Spirit-tech hybrid entities used by the Technocracy
...
x = SpiritCharacter.objects.get_or_create(
    ...
    essence=13,
    display=True,
)[0].add_source("Technocracy Reloaded", 242)
...
# ===== NEPHANDI SPIRITS =====
# Corrupted spirits serving darkness
...
x = SpiritCharacter.objects.get_or_create(
    ...
    essence=19,
    display=True,
)[0].add_source("Book of the Fallen", 143)
x.charms.set(
...
x = SpiritCharacter.objects.get_or_create(
    ...
    essence=24,
    display=True,
)[0].add_source("Book of the Fallen", 74)
x.charms.set(
    SpiritCharm.objects.filter(
...
# ===== LORE SPIRITS =====
# Spirits from specific Tradition lore
