...
def rote_helper(name, sphere_dict, practice, attribute, ability, description=""):
    return Rote.objects.get_or_create(
        ...
        effect=Effect.objects.get_or_create(name=name, **sphere_dict, description=description)[0],
...
rote_helper("Putrefaction", {"entropy": 3}, "Alchemy", "Intelligence", "Science").add_source(
    "Prism of Focus", 34
)
rote_helper(
...
rote_helper("Quiet as a Mouse", {"forces": 2}, "Animalism", "Dexterity", "Stealth").add_source(
    "Prism of Focus", 38
)
rote_helper("Call of the Heart", {"spirit": 2}, "Animalism", "Charisma", "Awareness").add_source(
    "Prism of Focus", 38
)
rote_helper("Mine!", {"mind": 3}, "Appropriation", "Charisma", "Intimidation").add_source(
    "Prism of Focus", 40
)
rote_helper(
    "Biased Contract",
...
rote_helper("Evoke Egregore", {"spirit": 2}, "Chaos Magick", "Charisma", "Intuition").add_source(
    "Prism of Focus", 50
)
rote_helper("Gift of the Self", {"prime": 3}, "Charity", "Charisma", "Crafts").add_source(
    "Prism of Focus", 51
)
rote_helper("Laying a Helping Hand", {"life": 3}, "Charity", "Manipulation", "Empathy").add_source(
    "Prism of Focus", 52
)
...
rote_helper("Unweave Fate", {"entropy": 5}, "Craftwork", "Dexterity", "Crafts").add_source(
    "Prism of Focus", 54
)
rote_helper("Flawless Creation", {"entropy": 3}, "Craftwork", "Dexterity", "Art").add_source(
    "Prism of Focus", 55
)
rote_helper(
    "Inversion Festival",
...
rote_helper("Inside Out", {"mind": 4}, "Crazy Wisdom", "Perception", "Meditation").add_source(
    "Prism of Focus", 57
)
rote_helper(
...
rote_helper("Pulley Redirect", {"forces": 2}, "Cybernetics", "Strength", "Science").add_source(
    "Prism of Focus", 60
)
rote_helper(
...
rote_helper("My Will Be Done", {"mind": 4}, "Dominion", "Charisma", "Belief Systems").add_source(
    "Prism of Focus", 63
)
rote_helper(
    "Mind over Matter",
...
rote_helper("Deity's Wrath", {"entropy": 4}, "Faith", "Charisma", "Theology").add_source(
    "Prism of Focus", 69
)
rote_helper("Healing Prayer", {"life": 3}, "Faith", "Stamina", "Belief Systems").add_source(
    "Prism of Focus", 69
)
rote_helper(
...
rote_helper("Gang Sign", {"mind": 2}, "Gutter Magick", "Charisma", "Streetwise").add_source(
    "Prism of Focus", 75
)
rote_helper("Power Outage", {"forces": 2}, "Gutter Magick", "Dexterity", "Technology").add_source(
    "Prism of Focus", 75
)
rote_helper(
...
rote_helper("Material Improvement", {"matter": 3}, "Investment", "Intelligence", "Law").add_source(
    "Prism of Focus", 86
)
rote_helper(
    "Asset Flip",
...
rote_helper("Energizing Touch", {"prime": 3}, "Invigoration", "Strength", "Athletics").add_source(
    "Prism of Focus", 89
)
rote_helper("Cool and Collected", {"mind": 1}, "Invigoration", "Wits", "Meditation").add_source(
    "Prism of Focus", 89
)
rote_helper("Pain Suppression", {"life": 2}, "Invigoration", "Stamina", "Brawl").add_source(
    "Prism of Focus", 89
)
rote_helper(
    "Harvest Blight",
...
rote_helper("Mental Eclipse", {"mind": 3}, "Maleficia", "Manipulation", "Enigmas").add_source(
    "Prism of Focus", 91
)
rote_helper(
    "Mark of the Outcast",
...
rote_helper("Double Jump", {"forces": 3}, "Martial Arts", "Strength", "Athletics").add_source(
    "Prism of Focus", 94
)
rote_helper(
    "Monkey Mischief", {"forces": 2}, "Martial Arts", "Manipulation", "Intimidation"
).add_source("Prism of Focus", 94)
rote_helper("Poison Purge", {"life": 2}, "Martial Arts", "Stamina", "Esoterica").add_source(
    "Prism of Focus", 94
)
rote_helper(
...
rote_helper("Anesthesia", {"life": 2}, "Medicine-Work", "Stamina", "Medicine").add_source(
    "Prism of Focus", 99
)
rote_helper(
    "Cleanup", {"matter": 3, "entropy": 3}, "Medicine-Work", "Intelligence", "Science"
).add_source("Prism of Focus", 99)
rote_helper("Cleansing Rite", {"prime": 5}, "Medicine-Work", "Charisma", "Meditation").add_source(
    "Prism of Focus", 100
)
rote_helper(
...
rote_helper("Spirit Guide", {"spirit": 2}, "Mediumship", "Charisma", "Cosmology").add_source(
    "Prism of Focus", 102
)
rote_helper(
    "Ghost Hunter's Eye",
...
rote_helper("Mental Push", {"forces": 2}, "Psionics", "Intelligence", "Intimidation").add_source(
    "Prism of Focus", 104
)
rote_helper("Reading the Leaves", {"time": 2}, "Psionics", "Perception", "Enigmas").add_source(
    "Prism of Focus", 104
)
rote_helper(
    "Bit Flip",
...
rote_helper("MacGuyver", {"matter": 4}, "Reality Hacking", "Wits", "Jury-Rigging").add_source(
    "Prism of Focus", 107
)
rote_helper(
...
rote_helper("Rite of the Sun and Moon", {"entropy": 4}, "Shamanism", "Wits", "Enigmas").add_source(
    "Prism of Focus", 111
)
rote_helper(
    "Ancestral Guidance",
...
rote_helper("Koulè Yo (mind)", {"mind": 1}, "Voudoun", "Perception", "Awareness").add_source(
    "Prism of Focus", 114
)
rote_helper("Koulè Yo (spirit)", {"spirit": 1}, "Voudoun", "Perception", "Awareness").add_source(
    "Prism of Focus", 114
)
rote_helper(
    "Simbi's Flow", {"spirit": 2, "matter": 2}, "Voudoun", "Charisma", "Belief Systems"
).add_source("Prism of Focus", 114)
rote_helper("Surviving Oggun's Forge", {"forces": 2}, "Voudoun", "Stamina", "Crafts").add_source(
    "Prism of Focus", 114
)
rote_helper(
    "Entanglement Engine",
...
rote_helper("Share a Cold", {"life": 3}, "Witchcraft", "Charisma", "Medicine").add_source(
    "Prism of Focus", 119
)
rote_helper("Familiar Soul", {"spirit": 4}, "Witchcraft", "Intelligence", "Occult").add_source(
    "Prism of Focus", 119
)
rote_helper("Break Curse", {"entropy": 1}, "Witchcraft", "Wits", "Awareness").add_source(
    "Prism of Focus", 120
)
rote_helper("Dig a Well", {"prime": 5}, "Witchcraft", "Strength", "Awareness").add_source(
    "Prism of Focus", 120
)
rote_helper(
...
rote_helper("Agni Prana", {"forces": 3, "prime": 2}, "Yoga", "Stamina", "Survival").add_source(
    "Prism of Focus", 123
)
