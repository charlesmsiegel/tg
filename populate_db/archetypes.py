...
architect = Archetype.objects.get_or_create(
    name="Architect",
...
)[0].add_source("Book of Secrets", 14).add_source(
...
barterer = Archetype.objects.get_or_create(
    name="Barterer"
)[0].add_source(
    "Werewolf: the Apocalypse 20th Anniversary Edition", 486
)
...
big_bad_wolf = Archetype.objects.get_or_create(
    name="Big Bad Wolf"
)[0].add_source(
    "Werewolf: the Apocalypse 20th Anniversary Edition", 486
)
bon_vivant = Archetype.objects.get_or_create(
    name="Bon Vivant",
...
bravo = Archetype.objects.get_or_create(
    name="Bravo"
)[0].add_source(
    "Werewolf: the Apocalypse 20th Anniversary Edition", 487
)
caregiver = Archetype.objects.get_or_create(
    name="Caregiver",
...
)[0].add_source("Book of Secrets", 15).add_source(
    "Werewolf: the Apocalypse 20th Anniversary Edition", 487
)
celebrant = Archetype.objects.get_or_create(
    name="Celebrant"
)[0].add_source(
    "Werewolf: the Apocalypse 20th Anniversary Edition", 487
)
...
conformist = Archetype.objects.get_or_create(
    name="Conformist",
...
conniver = Archetype.objects.get_or_create(
    name="Conniver"
)[0].add_source(
    "Werewolf: the Apocalypse 20th Anniversary Edition", 487
)
contrary = Archetype.objects.get_or_create(
    name="Contrary",
...
)[0].add_source("Mage: the Ascension 20th Anniversary Edition", 268).add_source(
    "Werewolf: the Apocalypse 20th Anniversary Edition", 487
)
...
cub = Archetype.objects.get_or_create(
    name="Cub"
)[0].add_source(
    "Werewolf: the Apocalypse 20th Anniversary Edition", 488
)
director = Archetype.objects.get_or_create(
    name="Director",
...
fanatic = Archetype.objects.get_or_create(
    name="Fanatic"
)[0].add_source(
    "Werewolf: the Apocalypse 20th Anniversary Edition", 488
)
fatalist = Archetype.objects.get_or_create(
    name="Fatalist"
)[0].add_source(
    "Werewolf: the Apocalypse 20th Anniversary Edition", 488
)
gallant = Archetype.objects.get_or_create(
    name="Gallant"
)[0].add_source(
    "Werewolf: the Apocalypse 20th Anniversary Edition", 488
)
...
guru = Archetype.objects.get_or_create(
    name="Guru"
)[0].add_source(
    "Werewolf: the Apocalypse 20th Anniversary Edition", 488
)
...
idealist = Archetype.objects.get_or_create(
    name="Idealist",
...
)[0].add_source("Mage: the Ascension 20th Anniversary Edition", 269).add_source(
    "Werewolf: the Apocalypse 20th Anniversary Edition", 488
)
...
judge = Archetype.objects.get_or_create(
    name="Judge"
)[0].add_source(
    "Werewolf: the Apocalypse 20th Anniversary Edition", 488
)
...
loner = Archetype.objects.get_or_create(
    name="Loner",
...
)[0].add_source("Mage: the Ascension 20th Anniversary Edition", 270).add_source(
...
martyr = Archetype.objects.get_or_create(
    name="Martyr",
...
)[0].add_source("Mage: the Ascension 20th Anniversary Edition", 271).add_source(
    "Werewolf: the Apocalypse 20th Anniversary Edition", 489
)
...
pedagogue = Archetype.objects.get_or_create(
    name="Pedagogue"
)[0].add_source(
    "Werewolf: the Apocalypse 20th Anniversary Edition", 489
)
penitent = Archetype.objects.get_or_create(
    name="Penitent"
)[0].add_source(
    "Werewolf: the Apocalypse 20th Anniversary Edition", 489
)
perfectionist = Archetype.objects.get_or_create(
    name="Perfectionist"
)[0].add_source(
...
rogue = Archetype.objects.get_or_create(
    name="Rogue",
...
)[0].add_source("Mage: the Ascension 20th Anniversary Edition", 272).add_source(
    "Werewolf: the Apocalypse 20th Anniversary Edition", 490
)
...
soldier = Archetype.objects.get_or_create(
    name="Soldier"
)[0].add_source(
    "Werewolf: the Apocalypse 20th Anniversary Edition", 490
)
survivor = Archetype.objects.get_or_create(
    name="Survivor",
...
thrill_seeker = Archetype.objects.get_or_create(
    name="Thrill-Seeker"
)[0].add_source(
    "Werewolf: the Apocalypse 20th Anniversary Edition", 490
)
traditionalist = Archetype.objects.get_or_create(
    name="Traditionalist",
...
trickster = Archetype.objects.get_or_create(
    name="Trickster",
...
)[0].add_source("Mage: the Ascension 20th Anniversary Edition", 273).add_source(
    "Werewolf: the Apocalypse 20th Anniversary Edition", 491
)
...
addict = Archetype.objects.get_or_create(
    name="Addict"
)[0].add_source("Demon: the Fallen", 132)
architect = Archetype.objects.get_or_create(
    name="Architect"
)[0].add_source(
    "Demon: the Fallen", 133
)
autocrat = Archetype.objects.get_or_create(
    name="Autocrat"
)[0].add_source("Demon: the Fallen", 133)
bon_vivant = Archetype.objects.get_or_create(
    name="Bon Vivant"
)[0].add_source(
    "Demon: the Fallen", 133
...
child = Archetype.objects.get_or_create(
    name="Child"
)[0].add_source("Demon: the Fallen", 133)
competitor = Archetype.objects.get_or_create(
    name="Competitor"
...
curmudgeon = Archetype.objects.get_or_create(
    name="Curmudgeon"
)[0].add_source(
    "Demon: the Fallen", 134
)
deviant = Archetype.objects.get_or_create(
    name="Deviant"
)[0].add_source("Demon: the Fallen", 134)
director = Archetype.objects.get_or_create(
    name="Director"
)[0].add_source("Demon: the Fallen", 134)
fanatic = Archetype.objects.get_or_create(
...
gambler = Archetype.objects.get_or_create(
    name="Gambler"
)[0].add_source("Demon: the Fallen", 134)
judge = Archetype.objects.get_or_create(
    name="Judge"
...
masochist = Archetype.objects.get_or_create(
    name="Masochist"
)[0].add_source(
...
monster = Archetype.objects.get_or_create(
    name="Monster"
)[0].add_source("Demon: the Fallen", 135)
pedagogue = Archetype.objects.get_or_create(
    name="Pedagogue"
)[0].add_source(
    "Demon: the Fallen", 135
...
zealot = Archetype.objects.get_or_create(
    name="Zealot"
)[0].add_source("Demon: the Fallen", 136)
damned_soul = Archetype.objects.get_or_create(
    name="Damned Soul"
)[0].add_source(
    "Dammned and Deceived", 60
)
narcissist = Archetype.objects.get_or_create(
    name="Narcissist"
)[0].add_source(
    "Dammned and Deceived", 60
)
proselytizer = Archetype.objects.get_or_create(
    name="Proselytizer"
)[0].add_source(
