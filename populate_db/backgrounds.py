...
arcane.save()
artifact = Background.objects.get_or_create(name="Artifact", property_name="artifact")[0]
...
influence = Background.objects.get_or_create(name="Influence", property_name="influence")[0]
legend = Background.objects.get_or_create(name="Legend", property_name="legend")[0]
library = Background.objects.get_or_create(name="Library", property_name="library")[0]
node = Background.objects.get_or_create(name="Node", property_name="node")[0]
...
chimera = Background.objects.get_or_create(name="Chimera", property_name="chimera")[0]
dreamers = Background.objects.get_or_create(name="Dreamers", property_name="dreamers")[0]
holdings = Background.objects.get_or_create(name="Holdings", property_name="holdings")[0]
...
retinue = Background.objects.get_or_create(name="Retinue", property_name="retinue")[0]
title = Background.objects.get_or_create(name="Title", property_name="title")[0]
treasure = Background.objects.get_or_create(name="Treasure", property_name="treasure")[0]

rituals = Background.objects.get_or_create(name="Rituals", property_name="rituals")[0]
herd = Background.objects.get_or_create(name="Herd", property_name="herd")[0]
...
domain = Background.objects.get_or_create(name="Domain", property_name="domain")[0]
black_hand_membership = Background.objects.get_or_create(
...
fate = Background.objects.get_or_create(name="Fate", property_name="fate")[0]
fetish = Background.objects.get_or_create(name="Fetish", property_name="fetish")[0]
kinfolk_rating = Background.objects.get_or_create(name="Kinfolk", property_name="kinfolk_rating")[0]
...
rites = Background.objects.get_or_create(name="Rites", property_name="rites")[0]
...
haunt = Background.objects.get_or_create(name="Haunt", property_name="haunt")[0]
legacy = Background.objects.get_or_create(name="Legacy", property_name="legacy")[0]
...
notoriety = Background.objects.get_or_create(name="Notoriety", property_name="notoriety")[0]
relic = Background.objects.get_or_create(name="Relic", property_name="relic")[0]

elders = Background.objects.get_or_create(name="Elders", property_name="elders")[0]

eminence = Background.objects.get_or_create(name="Eminence", property_name="eminence")[0]
followers = Background.objects.get_or_create(name="Followers", property_name="followers")[0]
legacy = Background.objects.get_or_create(name="Legacy", property_name="legacy")[0]
pacts = Background.objects.get_or_create(name="Pacts", property_name="pacts")[0]
