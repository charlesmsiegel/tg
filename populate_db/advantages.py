...
alacrity = Advantage.objects.get_or_create(name="Alacrity")[0].add_source("Gods and Monsters", 201)
alacrity.add_ratings([2, 4, 6])
armor = Advantage.objects.get_or_create(name="Armor")[0].add_source("Gods and Monsters", 201)
...
aura = Advantage.objects.get_or_create(name="Aura")[0].add_source("Gods and Monsters", 202)
aura.add_ratings([3])
aww = Advantage.objects.get_or_create(name="Aww!")[0].add_source("Gods and Monsters", 202)
aww.add_ratings([1, 2, 3, 4])
bare_necessities = Advantage.objects.get_or_create(name="Bare Necessities")[0].add_source(
    "Gods and Monsters", 202
)
bare_necessities.add_ratings([1, 3])
bioluminescence = Advantage.objects.get_or_create(name="Bioluminescence")[0].add_source(
    "Gods and Monsters", 202
)
bioluminescence.add_ratings([1, 2, 3])
blending = Advantage.objects.get_or_create(name="Blending")[0].add_source("Gods and Monsters", 203)
...
claws_fangs_or_horns = Advantage.objects.get_or_create(name="Claws, Fangs, or Horns")[0].add_source(
    "Gods and Monsters", 203
)
claws_fangs_or_horns.add_ratings([3, 5, 7])
cause_insanity = Advantage.objects.get_or_create(name="Cause Insanity")[0].add_source(
    "Gods and Monsters", 203
)
...
elemental_touch = Advantage.objects.get_or_create(name="Elemental Touch")[0].add_source(
    "Gods and Monsters", 204
)
...
ferocity = Advantage.objects.get_or_create(name="Ferocity")[0].add_source("Gods and Monsters", 205)
...
hazardous_breath = Advantage.objects.get_or_create(name="Hazardous Breath")[0].add_source(
    "Gods and Monsters", 206
)
hazardous_breath.add_ratings([5, 10, 15, 20, 25, 30])
hazardous_breath_aggravated = Advantage.objects.get_or_create(name="Hazardous Breath (Aggravated)")[
    0
].add_source("Gods and Monsters", 206)
hazardous_breath_aggravated.add_ratings([10, 20, 30, 40, 50, 60])
hazardous_breath_caustic = Advantage.objects.get_or_create(name="Hazardous Breath (Caustic)")[
    0
].add_source("Gods and Monsters", 206)
...
homing_instinct = Advantage.objects.get_or_create(name="Homing Instinct")[0].add_source(
    "Gods and Monsters", 206
)
...
information_fount = Advantage.objects.get_or_create(name="Information Fount")[0].add_source(
    "Gods and Monsters", 207
)
...
musical_influence = Advantage.objects.get_or_create(name="Musical Influence")[0].add_source(
    "Gods and Monsters", 208
)
musical_influence.add_ratings([6])
musk = Advantage.objects.get_or_create(name="Musk")[0].add_source("Gods and Monsters", 208)
musk.add_ratings([3])
...
paradox_nullification = Advantage.objects.get_or_create(name="Paradox Nullification")[0].add_source(
    "Gods and Monsters", 209
)
paradox_nullification.add_ratings([2, 3, 4, 5, 6])
quills = Advantage.objects.get_or_create(name="Quills")[0].add_source("Gods and Monsters", 209)
...
read_and_write = Advantage.objects.get_or_create(name="Read and Write")[0].add_source(
    "Gods and Monsters", 210
)
read_and_write.add_ratings([1])
regrowth = Advantage.objects.get_or_create(name="Regrowth")[0].add_source("Gods and Monsters", 210)
...
size = Advantage.objects.get_or_create(name="Size")[0].add_source("Gods and Monsters", 34)
size.add_ratings([3, 5, 8])
soak_lethal_damage = Advantage.objects.get_or_create(name="Soak Lethal Damage")[0].add_source(
...
soul_sense_or_death_sense = Advantage.objects.get_or_create(name="Soul-Sense/Death-Sense")[
    0
].add_source("Gods and Monsters", 211)
soul_sense_or_death_sense.add_ratings([2, 3])
speed = Advantage.objects.get_or_create(name="Speed")[0].add_source("Gods and Monsters", 211)
...
tides_of_fortune = Advantage.objects.get_or_create(name="Tides of Fortune")[0].add_source(
...
unaging = Advantage.objects.get_or_create(name="Unaging")[0].add_source("Gods and Monsters", 213)
unaging.add_ratings([5])
universal_translator = Advantage.objects.get_or_create(name="Universal Translator")[0].add_source(
    "Gods and Monsters", 213
)
...
venom_contact = Advantage.objects.get_or_create(name="Venom (Contact)")[0].add_source(
    "Gods and Monsters", 213
)
...
water_breathing = Advantage.objects.get_or_create(name="Water-Breathing")[0].add_source(
    "Gods and Monsters", 214
)
water_breathing.add_ratings([2, 5])
webbing = Advantage.objects.get_or_create(name="Webbing")[0].add_source("Gods and Monsters", 214)
webbing.add_ratings([5])
wings = Advantage.objects.get_or_create(name="Wings")[0].add_source("Gods and Monsters", 214)
