...
Fetish.objects.get_or_create(
    ...
    rank=2,
    gnosis=7,
    description="A cloak, jacket, or body suit bound with a Chameleon Spirit. When activated, the Chameleon Skin changes color and pattern to match the wearer's surroundings, providing exceptional camouflage. The material shifts continuously, adapting to new environments as the wearer moves. Unlike mundane camouflage, the Chameleon Skin works in any environment - urban, forest, desert, or even the bizarre landscapes of the Umbra. The wearer seems to fade into the background, becoming nearly invisible to casual observation.",
...
Fetish.objects.get_or_create(
    ...
    rank=2,
    gnosis=5,
    description="A ritual dagger bound with a Vengeance Spirit. This weapon is forged with a specific purpose: to strike down those who have committed grave wrongs. When the wielder declares a specific crime or injustice that their target has committed, the Dagger of Retribution gains supernatural potency against that individual. The blade thirsts for righteous vengeance, dealing enhanced damage to the guilty party. However, if wielded for unjust purposes or personal spite rather than true retribution, the spirit within may turn on its bearer. Philodox and Ahroun often carry these daggers as instruments of justice.",
...
Fetish.objects.get_or_create(
    ...
    rank=4,
    gnosis=8,
    description="A magnificent cloak woven from hundreds of feathers and bound with a powerful Bird Spirit. When worn and activated, the Feathered Cloak grants the wearer the gift of flight. The user can soar through the air with the grace of a bird, whether in the physical world or the Umbra. The cloak doesn't change the wearer's form but allows them to defy gravity and ride the winds. Flight speed depends on the wearer's physical prowess, but most can match the speed of large birds. The cloak is particularly prized by Silver Fangs and other Garou who value dramatic displays of power.",
    spirit="Bird Spirit",
    display=False,
)[0].add_source("Werewolf: the Apocalypse 20th Anniversary Edition", 224)
Fetish.objects.get_or_create(
...
Fetish.objects.get_or_create(
    ...
    rank=0,
    gnosis=3,
    description="A small glass vial bound with an Ancestor, Divination, or Crow Spirit. The Test Vial is a diagnostic tool that can identify supernatural creatures by their blood or other bodily fluids. A drop of blood placed in the vial causes it to glow different colors depending on what kind of creature the sample came from: red for vampires, green for fae, blue for mages, silver for Garou, black for Wyrm-tainted beings, and so on. The vial can also detect diseases, poisons, and other contaminants. Glass Walkers and Children of Gaia use Test Vials to screen humans who wish to approach Kinfolk, ensuring they aren't possessed or tainted. Each vial can perform one test before needing to rest.",
