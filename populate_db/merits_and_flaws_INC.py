...
mf = MeritFlaw.objects.get_or_create(name="Alpha")[0].add_source("Gods and Monsters", 195)
mf.add_ratings([2])
mf.allowed_types.add(companion)
...
mf.add_ratings([-1, -2, -3, -4, -5])
mf.allowed_types.add(companion)
mf = MeritFlaw.objects.get_or_create(name="Animal")[0].add_source("Gods and Monsters", 197)
mf.add_ratings([-2])
mf.allowed_types.add(companion)
mf = MeritFlaw.objects.get_or_create(name="Aura")[0].add_source("Gods and Monsters", 202)
mf.add_ratings([-3])
mf.allowed_types.add(companion)
mf = MeritFlaw.objects.get_or_create(name="Beta")[0].add_source("Gods and Monsters", 197)
mf.add_ratings([-1])
mf.allowed_types.add(companion)
mf = MeritFlaw.objects.get_or_create(name="Broken")[0].add_source("Gods and Monsters", 197)
mf.add_ratings([-5])
mf.allowed_types.add(companion)
mf = MeritFlaw.objects.get_or_create(name="Limbless")[0].add_source("Gods and Monsters", 197)
mf.add_ratings([-5])
mf.allowed_types.add(companion)
mf = MeritFlaw.objects.get_or_create(name="Power Source")[0].add_source("Gods and Monsters", 198)
mf.add_ratings([-1, -2, -3, -4, -5])
mf.allowed_types.add(companion)
...
mf.add_ratings([-4])
mf.allowed_types.add(companion)
mf = MeritFlaw.objects.get_or_create(name="Omega")[0].add_source("Gods and Monsters", 197)
mf.add_ratings([-4])
mf.allowed_types.add(companion)
...
mf.add_ratings([-2])
mf.allowed_types.add(companion)
mf = MeritFlaw.objects.get_or_create(name="Weak Spot")[0].add_source("Gods and Monsters", 200)
mf.add_ratings([-3])
mf.allowed_types.add(companion)
mf = MeritFlaw.objects.get_or_create(name="Thaumivore")[0].add_source("Gods and Monsters", 199)
mf.add_ratings([-5])
mf.allowed_types.add(companion)
mf = MeritFlaw.objects.get_or_create(name="Unbelief")[0].add_source("Gods and Monsters", 199)
mf.add_ratings([-3, -5, -8])
mf.allowed_types.add(companion)

# M20 Sorcerer
mf = MeritFlaw.objects.get_or_create(name="Isolated Upbringing")[0].add_source("M20 Sorcerer", 106)
mf.add_ratings([-2])
mf.allowed_types.add(sorcerer)
mf = MeritFlaw.objects.get_or_create(name="Innocent")[0].add_source("M20 Sorcerer", 106)
mf.add_ratings([1])
mf.allowed_types.add(sorcerer)
mf = MeritFlaw.objects.get_or_create(name="Psychic Awareness")[0].add_source("M20 Sorcerer", 106)
mf.add_ratings([3])
mf.allowed_types.add(sorcerer)
mf = MeritFlaw.objects.get_or_create(name="Flow of Ki")[0].add_source("M20 Sorcerer", 106)
mf.add_ratings([3])
mf.allowed_types.add(sorcerer)
mf = MeritFlaw.objects.get_or_create(name="Force of Spirit")[0].add_source("M20 Sorcerer", 107)
mf.add_ratings([2])
mf.allowed_types.add(sorcerer)
mf = MeritFlaw.objects.get_or_create(name="Strength of Psyche")[0].add_source("M20 Sorcerer", 107)
mf.add_ratings([2])
mf.allowed_types.add(sorcerer)
mf = MeritFlaw.objects.get_or_create(name="Detached")[0].add_source("M20 Sorcerer", 107)
mf.add_ratings([4])
mf.allowed_types.add(sorcerer)
mf = MeritFlaw.objects.get_or_create(name="Black and White")[0].add_source("M20 Sorcerer", 107)
mf.add_ratings([-1])
mf.allowed_types.add(sorcerer)
mf = MeritFlaw.objects.get_or_create(name="Pacifist")[0].add_source("M20 Sorcerer", 107)
mf.add_ratings([-5])
mf.allowed_types.add(sorcerer)
mf = MeritFlaw.objects.get_or_create(name="Style Sleeper")[0].add_source("M20 Sorcerer", 107)
mf.add_ratings([2])
mf.allowed_types.add(sorcerer)
mf = MeritFlaw.objects.get_or_create(name="Twin Link")[0].add_source("M20 Sorcerer", 107)
mf.add_ratings([4, 6])
mf.allowed_types.add(sorcerer)
mf = MeritFlaw.objects.get_or_create(name="Wild Talent")[0].add_source("M20 Sorcerer", 107)
mf.add_ratings([4, 3, 2, 1, 0, -1, -2, -3, -4])
mf.allowed_types.add(sorcerer)
mf = MeritFlaw.objects.get_or_create(name="Path Natural")[0].add_source("M20 Sorcerer", 108)
mf.add_ratings([5])
mf.allowed_types.add(sorcerer)
mf = MeritFlaw.objects.get_or_create(name="Psychic Feedback")[0].add_source("M20 Sorcerer", 108)
mf.add_ratings([-1, -2, -6])
mf.allowed_types.add(sorcerer)
mf = MeritFlaw.objects.get_or_create(name="Psi Focus")[0].add_source("M20 Sorcerer", 108)
mf.add_ratings([-3, -4, -5])
mf.allowed_types.add(sorcerer)
mf = MeritFlaw.objects.get_or_create(name="Path Inept")[0].add_source("M20 Sorcerer", 108)
mf.add_ratings([-5])
mf.allowed_types.add(sorcerer)
mf = MeritFlaw.objects.get_or_create(name="Ritual Sleeper")[0].add_source("M20 Sorcerer", 108)
mf.add_ratings([-5])
mf.allowed_types.add(sorcerer)
...
MeritFlaw.objects.get_or_create(name="Enchanting Feature")[0].add_source("Book of Secrets", 37)
...
MeritFlaw.objects.get_or_create(name="Jack-of-all-Trades (Mage and Werewolf)")[0].add_source(
    "Book of Secrets", 45
)
...
MeritFlaw.objects.get_or_create(name="Legendary Attributes - Intelligence")[0].add_source(
    "Book of Secrets", 77
)
MeritFlaw.objects.get_or_create(name="Legendary Attributes - Manipulation")[0].add_source(
    "Book of Secrets", 77
)
...
MeritFlaw.objects.get_or_create(name="Paranormal Prohibition or Imperative")[0].add_source(
    "Book of Secrets", 83
)
...
x = MeritFlaw.objects.get_or_create(name="Prestigious Mentor")[0].add_source("Book of Secrets", 54)
x.add_ratings([1])
x.allowed_types.add(mage)
x.allowed_types.add(human)
x.allowed_types.add(sorcerer)
