...
Camp.objects.get_or_create(name="Order of Our Merciful Mother", tribe=black_furies)[0].add_source(
    "Werewolf: the Apocalypse 20th Anniversary Edition", 492
)
Camp.objects.get_or_create(name="The Sisterhood", tribe=black_furies)[0].add_source(
    "Werewolf: the Apocalypse 20th Anniversary Edition", 492
)
Camp.objects.get_or_create(name="The Temple of Artemis", tribe=black_furies)[0].add_source(
    "Werewolf: the Apocalypse 20th Anniversary Edition", 492
)
...
Camp.objects.get_or_create(name="Aethera Inamorata", tribe=children_of_gaia)[0].add_source(
    "Werewolf: the Apocalypse 20th Anniversary Edition", 493
)
Camp.objects.get_or_create(name="Angels in the Garden", tribe=children_of_gaia)[0].add_source(
    "Werewolf: the Apocalypse 20th Anniversary Edition", 493
)
Camp.objects.get_or_create(name="The Anounted Ones", tribe=children_of_gaia)[0].add_source(
    "Werewolf: the Apocalypse 20th Anniversary Edition", 493
)
Camp.objects.get_or_create(name="Bringers of Eternal Peace", tribe=children_of_gaia)[0].add_source(
    "Werewolf: the Apocalypse 20th Anniversary Edition", 494
)
Camp.objects.get_or_create(name="Demeter's Daughters", tribe=children_of_gaia)[0].add_source(
    "Werewolf: the Apocalypse 20th Anniversary Edition", 494
)
Camp.objects.get_or_create(name="Imminent Strike", tribe=children_of_gaia)[0].add_source(
    "Werewolf: the Apocalypse 20th Anniversary Edition", 494
)
Camp.objects.get_or_create(name="The One Tree", tribe=children_of_gaia)[0].add_source(
    "Werewolf: the Apocalypse 20th Anniversary Edition", 494
)
Camp.objects.get_or_create(name="The Patient Deed", tribe=children_of_gaia)[0].add_source(
    "Werewolf: the Apocalypse 20th Anniversary Edition", 494
)
Camp.objects.get_or_create(name="Seekers of the Lost Tribes", tribe=children_of_gaia)[0].add_source(
    "Werewolf: the Apocalypse 20th Anniversary Edition", 494
)
Camp.objects.get_or_create(name="Servants of Unicorn", tribe=children_of_gaia)[0].add_source(
    "Werewolf: the Apocalypse 20th Anniversary Edition", 494
)
...
Camp.objects.get_or_create(name="The Glorious Fist of Wotan", tribe=get_of_fenris)[0].add_source(
...
Camp.objects.get_or_create(name="The Swords of Heimdall", tribe=get_of_fenris)[0].add_source(
    "Werewolf: the Apocalypse 20th Anniversary Edition", 496
)
Camp.objects.get_or_create(name="The Valkyria of Freya", tribe=get_of_fenris)[0].add_source(
...
Camp.objects.get_or_create(name="Mechanical Awakening", tribe=glass_walker)[0].add_source(
    "Werewolf: the Apocalypse 20th Anniversary Edition", 497
)
...
Camp.objects.get_or_create(name="The Lodge of the Predator Kings", tribe=red_talons)[0].add_source(
    "Werewolf: the Apocalypse 20th Anniversary Edition", 498
)
...
Camp.objects.get_or_create(name="Lords of the Summit", tribe=shadow_lords)[0].add_source(
    "Werewolf: the Apocalypse 20th Anniversary Edition", 499
)
Camp.objects.get_or_create(name="Revolutionary Guard", tribe=shadow_lords)[0].add_source(
    "Werewolf: the Apocalypse 20th Anniversary Edition", 499
)
...
Camp.objects.get_or_create(name="The Dispossessed", tribe=silent_striders)[0].add_source(
    "Werewolf: the Apocalypse 20th Anniversary Edition", 500
)
Camp.objects.get_or_create(name="Harbingers", tribe=silent_striders)[0].add_source(
    "Werewolf: the Apocalypse 20th Anniversary Edition", 500
)
Camp.objects.get_or_create(name="Eaters of the Dead", tribe=silent_striders)[0].add_source(
    "Werewolf: the Apocalypse 20th Anniversary Edition", 500
)
...
Camp.objects.get_or_create(name="Masters of the Seal", tribe=silver_fangs)[0].add_source(
    "Werewolf: the Apocalypse 20th Anniversary Edition", 502
)
...
Camp.objects.get_or_create(name="The Heavenly Successors of the Demon-Eater", tribe=stargazers)[
    0
...
Camp.objects.get_or_create(name="Lodge of the Moon", tribe=silver_fangs, camp_type="lodge")[
    0
].add_source("Werewolf: the Apocalypse 20th Anniversary Edition", 501)
Camp.objects.get_or_create(name="Lodge of the Sun", tribe=silver_fangs, camp_type="lodge")[
    0
].add_source("Werewolf: the Apocalypse 20th Anniversary Edition", 501)
Camp.objects.get_or_create(name="House Austere Howl", tribe=silver_fangs, camp_type="house")[
    0
].add_source("Werewolf: the Apocalypse 20th Anniversary Edition", 501)
Camp.objects.get_or_create(name="The Blood-Red Crest", tribe=silver_fangs, camp_type="house")[
    0
].add_source("Werewolf: the Apocalypse 20th Anniversary Edition", 501)
Camp.objects.get_or_create(name="Clan Crescent Moon", tribe=silver_fangs, camp_type="house")[
    0
].add_source("Werewolf: the Apocalypse 20th Anniversary Edition", 501)
Camp.objects.get_or_create(name="House Gleaming Eye", tribe=silver_fangs, camp_type="house")[
    0
].add_source("Werewolf: the Apocalypse 20th Anniversary Edition", 501)
Camp.objects.get_or_create(name="House Unbreakable Hearth", tribe=silver_fangs, camp_type="house")[
    0
].add_source("Werewolf: the Apocalypse 20th Anniversary Edition", 501)
Camp.objects.get_or_create(name="House Wise Heart", tribe=silver_fangs, camp_type="house")[
    0
].add_source("Werewolf: the Apocalypse 20th Anniversary Edition", 502)
Camp.objects.get_or_create(name="House Wyrmfoe", tribe=silver_fangs, camp_type="house")[
    0
].add_source("Werewolf: the Apocalypse 20th Anniversary Edition", 502)
Camp.objects.get_or_create(name="Renewalists", tribe=silver_fangs, camp_type="philosophy")[
    0
].add_source("Werewolf: the Apocalypse 20th Anniversary Edition", 502)
Camp.objects.get_or_create(name="Royalists", tribe=silver_fangs, camp_type="philosophy")[
    0
].add_source("Werewolf: the Apocalypse 20th Anniversary Edition", 502)
