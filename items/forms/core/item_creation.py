...
class ItemCreationForm(ChainedSelectMixin, forms.Form):
    ...
    item_type = ChainedChoiceField(parent_field="gameline", choices_map={}, label="Item Type")
    ...
    def __init__(self, *args, **kwargs):
        ...
        if not user or not user.is_authenticated:
            return
        entries = get_registry("items").menu(user)
        choices = {}
        ...
        self.fields["item_type"].choices_map = choices
        self._setup_chains()
