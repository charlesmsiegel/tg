...
urls = [
    ...
    path("melee_weapon/<pk>/", views.core.MeleeWeaponDetailView.as_view(), name="melee_weapon"),
    path("ranged_weapon/<pk>/", views.core.RangedWeaponDetailView.as_view(), name="ranged_weapon"),
    path("thrown_weapon/<pk>/", views.core.ThrownWeaponDetailView.as_view(), name="thrown_weapon"),
