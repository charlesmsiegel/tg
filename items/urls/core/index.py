...
urls = [
    ...
    path("ranged_weapon/", views.core.RangedWeaponListView.as_view(), name="ranged_weapon"),
    path("thrown_weapon/", views.core.ThrownWeaponListView.as_view(), name="thrown_weapon"),
]
