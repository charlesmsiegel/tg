...
class MtAHumanBasicsView(LoginRequiredMixin, FormView):
    ...
    def get_success_url(self):
        ...
        # Original: return reverse("characters:mage:mtahuman_template", kwargs={"pk": self.object.pk})
        self.object.creation_status = 1
        self.object.save()
        return reverse("characters:mage:mtahuman_creation", kwargs={"pk": self.object.pk})
