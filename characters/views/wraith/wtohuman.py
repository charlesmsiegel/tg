...
class WtOHumanBasicsView(LoginRequiredMixin, FormView):
    ...
    def get_success_url(self):
        ...
        # Original: return reverse("characters:wraith:wtohuman_template", kwargs={"pk": self.object.pk})
        self.object.creation_status = 1
        self.object.save()
        return reverse("characters:wraith:wtohuman_creation", kwargs={"pk": self.object.pk})
