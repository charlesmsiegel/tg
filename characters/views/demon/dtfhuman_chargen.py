...
class DtFHumanBasicsView(LoginRequiredMixin, FormView):
    ...
    def get_success_url(self):
        ...
        # Original: return reverse("characters:demon:dtfhuman_template", kwargs={"pk": self.object.pk})
        self.object.creation_status = 1
        self.object.save()
        return reverse("characters:demon:dtfhuman_creation", kwargs={"pk": self.object.pk})
