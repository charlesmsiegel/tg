...
class CtDHumanBasicsView(LoginRequiredMixin, FormView):
    ...
    def get_success_url(self):
        ...
        # Original: return reverse("characters:changeling:ctdhuman_template", kwargs={"pk": self.object.pk})
        self.object.creation_status = 1
        self.object.save()
        return reverse("characters:changeling:ctdhuman_creation", kwargs={"pk": self.object.pk})
...
#             CtDHuman, pk=kwargs["pk"], owner=request.user
#         )
