...
# Note: TestHumanFreebieFormPopulationViewPoolable was removed because
# AJAX-based freebie form population has been replaced with ChainedSelect.
# Poolable attribute is now handled via ChainedChoiceField's data attributes.
